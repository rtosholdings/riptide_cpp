...
const union {
  ...
  double d[4];
  __m256d m;
} __f64vec4_abs_mask = {0x7fffffffffffffff, 0x7fffffffffffffff,
...
} __f32vec8_finite_compare = {0x7f800000, 0x7f800000, 0x7f800000, 0x7f800000,
...
const union {
  ...
  // all 1 bits in exponent must be 1 (8 bits after sign)
  // and fraction must not be 0
} __f32vec8_finite_mask = {0x7fffffff, 0x7fffffff, 0x7fffffff, 0x7fffffff,
                           0x7fffffff, 0x7fffffff, 0x7fffffff, 0x7fffffff};
...
const union {
  ...
  // all 1 bits in exponent must be 1 (8 bits after sign)
  // and fraction must not be 0
} __f32vec8_inf_mask = {0x007fffff, 0x007fffff, 0x007fffff, 0x007fffff,
...
const union {
  ...
  // and fraction must not be 0
} __f64vec4_finite_mask = {0x7fffffffffffffff, 0x7fffffffffffffff,
                           0x7fffffffffffffff, 0x7fffffffffffffff};
...
const union {
  ...
  // all 1 bits in exponent must be 1 (11 bits after sign)
  // and fraction must not be 0
} __f64vec4_finite_compare = {0x7ff0000000000000, 0x7ff0000000000000,
...
const union {
  ...
  // all 1 bits in exponent must be 1 (11 bits after sign)
  // and fraction must not be 0
} __f64vec4_inf_mask = {0x000fffffffffffff, 0x000fffffffffffff,
...
template <typename T> static const inline T ABS_OP(T x) {
  return x < 0 ? -x : x;
}
template <typename T> static const inline double FABS_OP(T x) {
  return x < 0 ? -x : x;
}

// Invalid int mode (consider if we should return invalid when we discover
// invalid)
template <typename T> static const inline T SIGN_OP(T x) {
  return x > 0 ? 1 : x < 0 ? -1 : 0;
}

// If we find a nan, we return the same type of nan.  For instance -nan will
// return -nan instead of nan.
template <typename T> static const inline T FLOATSIGN_OP(T x) {
  return x > (T)(0.0) ? (T)(1.0)
                      : (x < (T)(0.0) ? (T)(-1.0) : (x == x ? (T)(0.0) : x));
}
...
template <typename T> static const inline T INVERT_OP_BOOL(int8_t x) {
  return x ^ 1;
}

template <typename T> static const inline bool NOT_OP(T x) {
  return (bool)(x == (T)0);
}

template <typename T> static const inline bool ISNOTNAN_OP(T x) {
  return !std::isnan(x);
}
template <typename T> static const inline bool ISNAN_OP(T x) {
  return std::isnan(x);
}
template <typename T> static const inline bool ISFINITE_OP(T x) {
  return std::isfinite(x);
}
template <typename T> static const inline bool ISNOTFINITE_OP(T x) {
  return !std::isfinite(x);
}
template <typename T> static const inline bool ISINF_OP(T x) {
  return std::isinf(x);
}
template <typename T> static const inline bool ISNOTINF_OP(T x) {
  return !std::isinf(x);
}
template <typename T> static const inline bool ISNORMAL_OP(T x) {
  return std::isnormal(x);
}
template <typename T> static const inline bool ISNOTNORMAL_OP(T x) {
  return !std::isnormal(x);
}
template <typename T> static const inline bool ISNANORZERO_OP(T x) {
  return x == 0.0 || std::isnan(x);
}

template <typename T> static const inline long double ROUND_OP(long double x) {
  return roundl(x);
}
template <typename T> static const inline double ROUND_OP(double x) {
  return round(x);
}
template <typename T> static const inline float ROUND_OP(float x) {
  return roundf(x);
}

template <typename T> static const inline long double FLOOR_OP(long double x) {
  return floorl(x);
}
template <typename T> static const inline double FLOOR_OP(double x) {
  return floor(x);
}
template <typename T> static const inline float FLOOR_OP(float x) {
  return floorf(x);
}

template <typename T> static const inline long double TRUNC_OP(long double x) {
  return truncl(x);
}
template <typename T> static const inline double TRUNC_OP(double x) {
  return trunc(x);
}
template <typename T> static const inline float TRUNC_OP(float x) {
  return truncf(x);
}

template <typename T> static const inline long double CEIL_OP(long double x) {
  return ceill(x);
}
template <typename T> static const inline double CEIL_OP(double x) {
  return ceil(x);
}
template <typename T> static const inline float CEIL_OP(float x) {
  return ceilf(x);
}

template <typename T> static const inline long double SQRT_OP(long double x) {
  return sqrtl(x);
}
template <typename T> static const inline double SQRT_OP(double x) {
  return sqrt(x);
}
template <typename T> static const inline float SQRT_OP(float x) {
  return sqrtf(x);
}

template <typename T> static const inline long double LOG_OP(long double x) {
  return logl(x);
}
template <typename T> static const inline double LOG_OP(double x) {
  return log(x);
}
template <typename T> static const inline float LOG_OP(float x) {
  return logf(x);
}

template <typename T> static const inline long double LOG2_OP(long double x) {
  return log2l(x);
}
template <typename T> static const inline double LOG2_OP(double x) {
  return log2(x);
}
template <typename T> static const inline float LOG2_OP(float x) {
  return log2f(x);
}

template <typename T> static const inline long double LOG10_OP(long double x) {
  return log10l(x);
}
template <typename T> static const inline double LOG10_OP(double x) {
  return log10(x);
}
template <typename T> static const inline float LOG10_OP(float x) {
  return log10f(x);
}

template <typename T> static const inline long double EXP_OP(long double x) {
  return expl(x);
}
template <typename T> static const inline double EXP_OP(double x) {
  return exp(x);
}
template <typename T> static const inline float EXP_OP(float x) {
  return expf(x);
}

template <typename T> static const inline long double EXP2_OP(long double x) {
  return exp2l(x);
}
template <typename T> static const inline double EXP2_OP(double x) {
  return exp2(x);
}
template <typename T> static const inline float EXP2_OP(float x) {
  return exp2f(x);
}

template <typename T> static const inline long double CBRT_OP(long double x) {
  return cbrtl(x);
}
template <typename T> static const inline double CBRT_OP(double x) {
  return cbrt(x);
}
template <typename T> static const inline float CBRT_OP(float x) {
  return cbrtf(x);
}

template <typename T> static const inline long double TAN_OP(long double x) {
  return tanl(x);
}
template <typename T> static const inline double TAN_OP(double x) {
  return tan(x);
}
template <typename T> static const inline float TAN_OP(float x) {
  return tanf(x);
}

template <typename T> static const inline long double COS_OP(long double x) {
  return cosl(x);
}
template <typename T> static const inline double COS_OP(double x) {
  return cos(x);
}
template <typename T> static const inline float COS_OP(float x) {
  return cosf(x);
}

template <typename T> static const inline long double SIN_OP(long double x) {
  return sinl(x);
}
template <typename T> static const inline double SIN_OP(double x) {
  return sin(x);
}
template <typename T> static const inline float SIN_OP(float x) {
  return sinf(x);
}

// NOTE: These routines can be vectorized
template <typename T> static const inline bool SIGNBIT_OP(long double x) {
  return std::signbit(x);
}
template <typename T> static const inline bool SIGNBIT_OP(double x) {
  return std::signbit(x);
}
template <typename T> static const inline bool SIGNBIT_OP(float x) {
  return std::signbit(x);
}
...
template <typename T> static const inline __m256 ROUND_OP_256(__m256 x) {
  return _mm_roundme_ps(x);
}
template <typename T> static const inline __m256d ROUND_OP_256(__m256d x) {
  return _mm_roundme_pd(x);
}

template <typename T> static const inline __m256 TRUNC_OP_256(__m256 x) {
  return _mm_truncme_ps(x);
}
template <typename T> static const inline __m256d TRUNC_OP_256(__m256d x) {
  return _mm_truncme_pd(x);
}

template <typename T> static const inline __m256 FLOOR_OP_256(__m256 x) {
  return _mm256_floor_ps(x);
}
template <typename T> static const inline __m256d FLOOR_OP_256(__m256d x) {
  return _mm256_floor_pd(x);
}

template <typename T> static const inline __m256 CEIL_OP_256(__m256 x) {
  return _mm256_ceil_ps(x);
}
template <typename T> static const inline __m256d CEIL_OP_256(__m256d x) {
  return _mm256_ceil_pd(x);
}

template <typename T> static const inline __m256 SQRT_OP_256(__m256 x) {
  return _mm256_sqrt_ps(x);
}
template <typename T> static const inline __m256d SQRT_OP_256(__m256d x) {
...
template <typename T, typename U256, const T MATH_OP(T),
          const U256 MATH_OP256(U256)>
static inline void UnaryOpFast(void *pDataIn, void *pDataOut, int64_t len,
...
template <typename T, typename U256, const T MATH_OP(T),
          const U256 MATH_OP256(U256)>
static inline void UnaryOpFastStrided(void *pDataIn, void *pDataOut,
                                      int64_t len, int64_t strideIn,
                                      int64_t strideOut) {
  ...
  if (sizeof(T) == strideOut && sizeof(T) == strideIn && len >= chunkSize) {
    ...
    __m256i mindex =
        _mm256_mullo_epi32(_mm256_set1_epi32(babyStride), __vec8_strides.m);
...
static inline void UnaryNanFastFloat(MathFunctionPtr MATH_OP, void *pDataIn,
  ...
  if (sizeof(bool) == strideOut && sizeof(T) == strideIn && len >= chunkSize) {
    ...
    while (pOut_i64 < pEnd_i64) {
      ...
      *pOut_i64++ = gBooleanLUT64Inverse
          [_mm256_movemask_ps(_mm256_cmp_ps(m0, m0, _CMP_EQ_OQ)) & 255];
    }
...
// MathOp operation to perform
template <typename T, typename U256, typename MathFunctionPtr>
static inline void UnaryNanFastDouble(MathFunctionPtr MATH_OP, void *pDataIn,
                                      void *pDataOut, int64_t len,
                                      int64_t strideIn, int64_t strideOut) {
  ...
  if (sizeof(bool) == strideOut && sizeof(T) == strideIn && len >= chunkSize) {
    ...
    while (pOut_i32 < pEnd_i32) {
      ...
      *pOut_i32++ = gBooleanLUT32Inverse
          [_mm256_movemask_pd(_mm256_cmp_pd(m0, m0, _CMP_EQ_OQ)) & 15];
    }
...
// MathOp operation to perform
template <typename T, typename U256, typename MathFunctionPtr>
static inline void UnaryNotNanFastFloat(MathFunctionPtr MATH_OP, void *pDataIn,
                                        void *pDataOut, int64_t len,
                                        int64_t strideIn, int64_t strideOut) {
  ...
  if (sizeof(bool) == strideOut && sizeof(T) == strideIn && len >= chunkSize) {
    ...
    while (pOut_i64 < pEnd_i64) {
      ...
      // +/-inf will equal eachother
      *pOut_i64++ =
          gBooleanLUT64[_mm256_movemask_ps(_mm256_cmp_ps(m0, m0, _CMP_EQ_OQ)) &
                        255];
    }
...
// MathOp operation to perform
template <typename T, typename U256, typename MathFunctionPtr>
static inline void UnaryNotNanFastDouble(MathFunctionPtr MATH_OP, void *pDataIn,
                                         void *pDataOut, int64_t len,
                                         int64_t strideIn, int64_t strideOut) {
  ...
  if (sizeof(bool) == strideOut && sizeof(T) == strideIn && len >= chunkSize) {
    ...
    while (pOut_i32 < pEnd_i32) {
      ...
      *pOut_i32++ =
          gBooleanLUT32[_mm256_movemask_pd(_mm256_cmp_pd(m0, m0, _CMP_EQ_OQ)) &
                        15];
    }
...
// MathOp operation to perform
template <typename T, typename U256, typename MathFunctionPtr>
static inline void UnaryFiniteFastFloat(MathFunctionPtr MATH_OP, void *pDataIn,
                                        void *pDataOut, int64_t len,
                                        int64_t strideIn, int64_t strideOut) {
  ...
  if (sizeof(bool) == strideOut && sizeof(T) == strideIn && len >= chunkSize) {
    ...
    while (pOut_i64 < pEnd_i64) {
      ...
      int32_t bitmask = _mm256_movemask_ps(_mm256_cmp_ps(
          m_finitecomp, _mm256_and_ps(m0, m_finitecomp), _CMP_NEQ_OQ));
...
// MathOp operation to perform
template <typename T, typename U256, typename MathFunctionPtr>
static inline void UnaryFiniteFastDouble(MathFunctionPtr MATH_OP, void *pDataIn,
                                         void *pDataOut, int64_t len,
                                         int64_t strideIn, int64_t strideOut) {
  ...
  if (sizeof(bool) == strideOut && sizeof(T) == strideIn && len >= chunkSize) {
    ...
    while (pOut_i32 < pEnd_i32) {
      ...
      int32_t bitmask = _mm256_movemask_pd(_mm256_cmp_pd(
          m_finitecomp, _mm256_and_pd(m0, m_finitecomp), _CMP_NEQ_OQ));
...
template <typename T, typename U256, typename MathFunctionPtr>
static inline void
UnaryNotFiniteFastFloat(MathFunctionPtr MATH_OP, void *pDataIn, void *pDataOut,
                        int64_t len, int64_t strideIn, int64_t strideOut) {
  ...
  if (sizeof(bool) == strideOut && sizeof(T) == strideIn && len >= chunkSize) {
    ...
    while (pOut_i64 < pEnd_i64) {
      ...
      int32_t bitmask = _mm256_movemask_ps(_mm256_cmp_ps(
          m_finitecomp, _mm256_and_ps(m0, m_finitecomp), _CMP_EQ_OQ));
...
template <typename T, typename U256, typename MathFunctionPtr>
static inline void
UnaryNotFiniteFastDouble(MathFunctionPtr MATH_OP, void *pDataIn, void *pDataOut,
                         int64_t len, int64_t strideIn, int64_t strideOut) {
  ...
  if (sizeof(bool) == strideOut && sizeof(T) == strideIn && len >= chunkSize) {
    ...
    while (pOut_i32 < pEnd_i32) {
      ...
      int32_t bitmask = _mm256_movemask_pd(_mm256_cmp_pd(
          m_finitecomp, _mm256_and_pd(m0, m_finitecomp), _CMP_EQ_OQ));
...
static void UnaryOpSlow(MathFunctionPtr MATH_OP, void *pDataIn, void *pDataOut,
                        int64_t len, int64_t strideIn, int64_t strideOut) {
...
// MathOp operation to perform
template <typename T, typename MathFunctionPtr>
static void UnaryOpSlowDouble(MathFunctionPtr MATH_OP, void *pDataIn,
                              void *pDataOut, int64_t len, int64_t strideIn,
                              int64_t strideOut) {
...
// MathOp operation to perform
template <typename T, typename MathFunctionPtr>
static void UnaryOpSlowBool(MathFunctionPtr MATH_OP, void *pDataIn,
                            void *pDataOut, int64_t len, int64_t strideIn,
                            int64_t strideOut) {
...
static void UnaryOpSlow_FillTrue(void *pDataIn1, void *pDataOut, int64_t len,
                                 int64_t strideIn, int64_t strideOut) {
...
static void UnaryOpSlow_FillFalse(void *pDataIn1, void *pDataOut, int64_t len,
                                  int64_t strideIn, int64_t strideOut) {
  if (strideOut == sizeof(bool)) {
...
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_ABS(void *pDataIn1, void *pDataOut, int64_t len,
                            int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(ABS_OP<T>, pDataIn1, pDataOut, len,
                                        strideIn, strideOut);
}

//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_FABS(void *pDataIn1, void *pDataOut, int64_t len,
                             int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const double (*)(T)>(FABS_OP<T>, pDataIn1, pDataOut,
                                             len, strideIn, strideOut);
}

//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_SIGN(void *pDataIn1, void *pDataOut, int64_t len,
                             int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(SIGN_OP<T>, pDataIn1, pDataOut, len,
                                        strideIn, strideOut);
}

//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_FLOATSIGN(void *pDataIn1, void *pDataOut, int64_t len,
                                  int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(FLOATSIGN_OP<T>, pDataIn1, pDataOut,
                                        len, strideIn, strideOut);
}

//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_NEG(void *pDataIn1, void *pDataOut, int64_t len,
                            int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(NEG_OP<T>, pDataIn1, pDataOut, len,
                                        strideIn, strideOut);
}

//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_ISNOTNAN(void *pDataIn1, void *pDataOut, int64_t len,
                                 int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowBool<T, const bool (*)(T)>(
      ISNOTNAN_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}
template <typename T>
static void UnaryOpSlow_ISNAN(void *pDataIn1, void *pDataOut, int64_t len,
                              int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowBool<T, const bool (*)(T)>(ISNAN_OP<T>, pDataIn1, pDataOut,
                                               len, strideIn, strideOut);
}

template <typename T>
static void UnaryOpSlow_ISNANORZERO(void *pDataIn1, void *pDataOut, int64_t len,
                                    int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowBool<T, const bool (*)(T)>(
      ISNANORZERO_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}

template <typename T>
static void UnaryOpSlow_ISINVALID(void *pDataIn1, void *pDataOut, int64_t len,
                                  int64_t strideIn, int64_t strideOut) {
  T *pIn = (T *)pDataIn1;
...
template <typename T>
static void UnaryOpSlow_ISINVALIDORZERO(void *pDataIn1, void *pDataOut,
                                        int64_t len, int64_t strideIn,
                                        int64_t strideOut) {
  T *pIn = (T *)pDataIn1;
  T invalid = *(T *)GetInvalid<T>();
...
template <typename T>
static void UnaryOpSlow_ISNOTINVALID(void *pDataIn1, void *pDataOut,
                                     int64_t len, int64_t strideIn,
                                     int64_t strideOut) {
  T *pIn = (T *)pDataIn1;
  T invalid = *(T *)GetInvalid<T>();
...
template <typename T>
static void UnaryOpSlow_ISFINITE(void *pDataIn1, void *pDataOut, int64_t len,
                                 int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowBool<T, const bool (*)(T)>(
      ISFINITE_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}

template <typename T>
static void UnaryOpSlow_ISNOTFINITE(void *pDataIn1, void *pDataOut, int64_t len,
                                    int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowBool<T, const bool (*)(T)>(
      ISNOTFINITE_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}

template <typename T>
static void UnaryOpSlow_ISINF(void *pDataIn1, void *pDataOut, int64_t len,
                              int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowBool<T, const bool (*)(T)>(ISINF_OP<T>, pDataIn1, pDataOut,
                                               len, strideIn, strideOut);
}

template <typename T>
static void UnaryOpSlow_ISNOTINF(void *pDataIn1, void *pDataOut, int64_t len,
                                 int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowBool<T, const bool (*)(T)>(
      ISNOTINF_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}

template <typename T>
static void UnaryOpSlow_ISNORMAL(void *pDataIn1, void *pDataOut, int64_t len,
                                 int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowBool<T, const bool (*)(T)>(
      ISNORMAL_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}

template <typename T>
static void UnaryOpSlow_ISNOTNORMAL(void *pDataIn1, void *pDataOut, int64_t len,
                                    int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowBool<T, const bool (*)(T)>(
      ISNOTNORMAL_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}

template <typename T>
static void UnaryOpSlow_SIGNBIT(void *pDataIn1, void *pDataOut, int64_t len,
                                int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowBool<T, const bool (*)(T)>(
      SIGNBIT_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}

//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_NOT(void *pDataIn1, void *pDataOut, int64_t len,
                            int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowBool<T, const bool (*)(T)>(NOT_OP<T>, pDataIn1, pDataOut,
                                               len, strideIn, strideOut);
}

//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_INVERT(void *pDataIn1, void *pDataOut, int64_t len,
                               int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(INVERT_OP<T>, pDataIn1, pDataOut, len,
                                        strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_INVERT_BOOL(void *pDataIn1, void *pDataOut, int64_t len,
                                    int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(INVERT_OP_BOOL<T>, pDataIn1, pDataOut,
                                        len, strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_FLOOR(void *pDataIn1, void *pDataOut, int64_t len,
                              int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(FLOOR_OP<T>, pDataIn1, pDataOut, len,
                                        strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_CEIL(void *pDataIn1, void *pDataOut, int64_t len,
                             int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(CEIL_OP<T>, pDataIn1, pDataOut, len,
                                        strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_TRUNC(void *pDataIn1, void *pDataOut, int64_t len,
                              int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(TRUNC_OP<T>, pDataIn1, pDataOut, len,
                                        strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_ROUND(void *pDataIn1, void *pDataOut, int64_t len,
                              int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(ROUND_OP<T>, pDataIn1, pDataOut, len,
                                        strideIn, strideOut);
}

//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_SQRT(void *pDataIn1, void *pDataOut, int64_t len,
                             int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(SQRT_OP<T>, pDataIn1, pDataOut, len,
                                        strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_CBRT(void *pDataIn1, void *pDataOut, int64_t len,
                             int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(CBRT_OP<T>, pDataIn1, pDataOut, len,
                                        strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_LOG(void *pDataIn1, void *pDataOut, int64_t len,
                            int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(LOG_OP<T>, pDataIn1, pDataOut, len,
                                        strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_LOG2(void *pDataIn1, void *pDataOut, int64_t len,
                             int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(LOG2_OP<T>, pDataIn1, pDataOut, len,
                                        strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_LOG10(void *pDataIn1, void *pDataOut, int64_t len,
                              int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(LOG10_OP<T>, pDataIn1, pDataOut, len,
                                        strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_EXP(void *pDataIn1, void *pDataOut, int64_t len,
                            int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(EXP_OP<T>, pDataIn1, pDataOut, len,
                                        strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlow_EXP2(void *pDataIn1, void *pDataOut, int64_t len,
                             int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlow<T, const T (*)(T)>(EXP2_OP<T>, pDataIn1, pDataOut, len,
                                        strideIn, strideOut);
}

//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlowDouble_SQRT(void *pDataIn1, void *pDataOut, int64_t len,
                                   int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowDouble<T, const double (*)(double)>(
      SQRT_OP<double>, pDataIn1, pDataOut, len, strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlowDouble_CBRT(void *pDataIn1, void *pDataOut, int64_t len,
                                   int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowDouble<T, const double (*)(double)>(
      CBRT_OP<double>, pDataIn1, pDataOut, len, strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlowDouble_LOG(void *pDataIn1, void *pDataOut, int64_t len,
                                  int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowDouble<T, const double (*)(double)>(
      LOG_OP<double>, pDataIn1, pDataOut, len, strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlowDouble_LOG2(void *pDataIn1, void *pDataOut, int64_t len,
                                   int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowDouble<T, const double (*)(double)>(
      LOG2_OP<double>, pDataIn1, pDataOut, len, strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlowDouble_LOG10(void *pDataIn1, void *pDataOut, int64_t len,
                                    int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowDouble<T, const double (*)(double)>(
      LOG10_OP<double>, pDataIn1, pDataOut, len, strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlowDouble_EXP(void *pDataIn1, void *pDataOut, int64_t len,
                                  int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowDouble<T, const double (*)(double)>(
      EXP_OP<double>, pDataIn1, pDataOut, len, strideIn, strideOut);
}
//-------------------------------------------------------------------
template <typename T>
static void UnaryOpSlowDouble_EXP2(void *pDataIn1, void *pDataOut, int64_t len,
                                   int64_t strideIn, int64_t strideOut) {
  return UnaryOpSlowDouble<T, const double (*)(double)>(
      EXP2_OP<double>, pDataIn1, pDataOut, len, strideIn, strideOut);
}
...
static inline void UnaryOpFast_NANF32(void *pDataIn1, void *pDataOut,
                                      int64_t len, int64_t strideIn,
                                      int64_t strideOut) {
  return UnaryNanFastFloat<T, U256, const bool (*)(T)>(
      ISNAN_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}
template <typename T, typename U256>
static inline void UnaryOpFast_NANF64(void *pDataIn1, void *pDataOut,
                                      int64_t len, int64_t strideIn,
                                      int64_t strideOut) {
  return UnaryNanFastDouble<T, U256, const bool (*)(T)>(
      ISNAN_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}

template <typename T, typename U256>
static inline void UnaryOpFast_NOTNANF32(void *pDataIn1, void *pDataOut,
                                         int64_t len, int64_t strideIn,
                                         int64_t strideOut) {
  return UnaryNotNanFastFloat<T, U256, const bool (*)(T)>(
      ISNOTNAN_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}
template <typename T, typename U256>
static inline void UnaryOpFast_NOTNANF64(void *pDataIn1, void *pDataOut,
                                         int64_t len, int64_t strideIn,
                                         int64_t strideOut) {
  return UnaryNotNanFastDouble<T, U256, const bool (*)(T)>(
      ISNOTNAN_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}

template <typename T, typename U256>
static inline void UnaryOpFast_FINITEF32(void *pDataIn1, void *pDataOut,
                                         int64_t len, int64_t strideIn,
                                         int64_t strideOut) {
  return UnaryFiniteFastFloat<T, U256, const bool (*)(T)>(
      ISFINITE_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}
template <typename T, typename U256>
static inline void UnaryOpFast_FINITEF64(void *pDataIn1, void *pDataOut,
                                         int64_t len, int64_t strideIn,
                                         int64_t strideOut) {
  return UnaryFiniteFastDouble<T, U256, const bool (*)(T)>(
      ISFINITE_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}

template <typename T, typename U256>
static inline void UnaryOpFast_NOTFINITEF32(void *pDataIn1, void *pDataOut,
                                            int64_t len, int64_t strideIn,
                                            int64_t strideOut) {
  return UnaryNotFiniteFastFloat<T, U256, const bool (*)(T)>(
      ISNOTFINITE_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}
template <typename T, typename U256>
static inline void UnaryOpFast_NOTFINITEF64(void *pDataIn1, void *pDataOut,
                                            int64_t len, int64_t strideIn,
                                            int64_t strideOut) {
  return UnaryNotFiniteFastDouble<T, U256, const bool (*)(T)>(
      ISNOTFINITE_OP<T>, pDataIn1, pDataOut, len, strideIn, strideOut);
}

UNARY_FUNC GetUnaryOpSlow(int func, int numpyInType1, int numpyOutType,
                          int *wantedOutType) {
  LOGGING("Looking for func slow %d  type %d  outtype: %d\n", func,
          numpyInType1, numpyOutType);
...
UNARY_FUNC GetUnaryOpFast(int func, int numpyInType1, int numpyOutType,
                          int *wantedOutType) {
  ...
  case MATH_OPERATION::FLOOR:
    *wantedOutType = numpyInType1;
    ...
    case NPY_DOUBLE:
      return UnaryOpFast<double, __m256d, FLOOR_OP<double>,
                         FLOOR_OP_256<__m256d>>;
    }
    break;
  case MATH_OPERATION::CEIL:
    *wantedOutType = numpyInType1;
    ...
    case NPY_DOUBLE:
      return UnaryOpFast<double, __m256d, CEIL_OP<double>,
                         CEIL_OP_256<__m256d>>;
    }
    break;
  case MATH_OPERATION::TRUNC:
    *wantedOutType = numpyInType1;
    ...
    case NPY_DOUBLE:
      return UnaryOpFast<double, __m256d, TRUNC_OP<double>,
                         TRUNC_OP_256<__m256d>>;
    }
    break;
  case MATH_OPERATION::ROUND:
    *wantedOutType = numpyInType1;
    ...
    case NPY_DOUBLE:
      return UnaryOpFast<double, __m256d, ROUND_OP<double>,
                         ROUND_OP_256<__m256d>>;
    }
    break;
  case MATH_OPERATION::SQRT:
    *wantedOutType = NPY_DOUBLE;
    ...
    case NPY_DOUBLE:
      return UnaryOpFast<double, __m256d, SQRT_OP<double>,
                         SQRT_OP_256<__m256d>>;
    }
    break;
  }
...
//--------------------------------------------------------------------
//
UNARY_FUNC_STRIDED GetUnaryOpFastStrided(int func, int numpyInType1,
                                         int numpyOutType, int *wantedOutType) {
  ...
  case MATH_OPERATION::ABS:
    *wantedOutType = numpyInType1;
    switch (numpyInType1) {
    case NPY_FLOAT:
      return UnaryOpFastStrided<float, __m256, ABS_OP<float>,
                                ABS_OP_256<__m256>>;
...
static UNARY_FUNC CheckMathOpOneInput(int func, int numpyInType1,
                                      int numpyOutType, int *wantedOutType) {
  ...
  if (numpyInType1 <= NPY_LONGDOUBLE) {
    ...
    if (pOneFunc == NULL) {
      LOGGING("Unary fast func not found for func %d  type %d\n", func,
              numpyInType1);
      pOneFunc =
          GetUnaryOpSlow(func, numpyInType1, numpyOutType, wantedOutType);
    }
  }
  return pOneFunc;
}
...
static bool UnaryThreadCallbackStrided(struct stMATH_WORKER_ITEM *pstWorkerItem,
  ...
  while ((lenX = pstWorkerItem->GetNextWorkBlock(&workBlock)) > 0) {
    ...
    int64_t inputAdj =
        pstWorkerItem->BlockSize * workBlock * Callback->itemSizeIn;
    int64_t outputAdj =
        pstWorkerItem->BlockSize * workBlock * Callback->itemSizeOut;

    LOGGING("[%d] working on %lld with len %lld   block: %lld\n", core,
            workIndex, lenX, workBlock);
    Callback->pUnaryCallbackStrided(pDataIn + inputAdj, pDataOut + outputAdj,
                                    lenX, Callback->itemSizeIn,
...
PyObject *ProcessOneInput(PyArrayObject *inArray, PyArrayObject *outObject1,
                          int funcNumber, int numpyInType1,
                          int numpyOutType = -1, int axis = 0) {

  LOGGING("In process one input %d %d %d\n", funcNumber, numpyInType1,
          numpyOutType);
  int ndim;
  int64_t strideIn;
  ...
  if (directionIn == 0 && numpyOutType == -1) {
    ...
    UNARY_FUNC pUnaryFunc = CheckMathOpOneInput(
        funcNumber, numpyInType1, numpyOutType, &wantedOutputType);

    if (pUnaryFunc) {

      LOGGING("Fastpath: Going to allocate   contig: %d  len: %lld\n",
              PyArray_FLAGS(inArray) &
                  (NPY_ARRAY_F_CONTIGUOUS | NPY_ARRAY_C_CONTIGUOUS),
              len);
      // This will always produce a contiguous array
      PyArrayObject *outputArray =
          (ndim <= 1)
              ? AllocateNumpyArray(1, (npy_intp *)&len, wantedOutputType)
      ...
      if (outputArray) {
        ...
        if (pWorkItem == NULL) {
          ...
          // main thread
          pUnaryFunc(pDataIn, pDataOut, len, strideIn,
                     PyArray_ITEMSIZE(outputArray));
        } else {
  ...
  UNARY_FUNC pUnaryFunc = CheckMathOpOneInput(funcNumber, numpyInType1,
                                              numpyOutType, &wantedOutputType);
  ...
  if (pUnaryFunc && wantedOutputType != -1) {
    ...
    if (numpyOutType == -1) {
      ...
      if (len != lenOut) {
        LOGGING("Wanted output length does not match %lld vs %lld or output is "
                "not contiguous\n",
                len, lenOut);
        // punt to numpy
        RETURN_NONE;
    ...
    if (directionIn == 0 && directionOut == 0) {
      ...
      if (directionIn == 1 && directionOut == 0) {
        ...
        for (int64_t j = 0; j < outerLen; j++) {
          pUnaryFunc((char *)pDataIn + (j * outerStride),
                     (char *)pDataOut + (j * innerLen * strideOut), innerLen,
                     strideIn, strideOut);
        }
...
PyObject *BasicMathOneInput(PyObject *self, PyObject *args) {
  ...
  if (PyTuple_CheckExact(tuple)) {
    ...
    if (tupleSize != 1 && tupleSize != 2) {
      PyErr_Format(
          PyExc_ValueError,
          "BasicMathOneInput only takes 1 or 2 arguments instead of %llu args",
          tupleSize);
      return NULL;
    }
  ...
  if (!IsFastArrayOrNumpy((PyArrayObject *)inObject1)) {
    PyErr_Format(PyExc_ValueError,
                 "BasicMathOneInput first argument is not an array");
    return NULL;
  }
  ...
  if (tupleSize == 2) {
    ...
    if (!IsFastArrayOrNumpy(outObject1)) {
      PyErr_Format(PyExc_ValueError,
                   "BasicMathOneInput out argument is not an array but type %s",
  ...
  return ProcessOneInput((PyArrayObject *)inObject1, outObject1,
                         (int)funcNumber, numpyInType1, (int)numpyOutType);
}

//-----------------------------------------------------------------------------------
// Called internally when python numbermethod called
PyObject *BasicMathOneInputFromNumber(PyArrayObject *inObject1,
                                      int64_t funcNumber, bool inplace) {
  UNARY_FUNC pOneFunc = NULL;
  ...
  // returns None when punting
  return ProcessOneInput((PyArrayObject *)inObject1, outObject1,
                         (int)funcNumber, numpyInType1, numpyOutType);
}
...
PyObject *BasicMathUnaryOp(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (kwargs) {
    ...
    if (dtypekwarg) {
      ...
      if (!IsFastArrayOrNumpy(outObject1)) {
        PyErr_Format(PyExc_ValueError,
                     "BasicMathUnaryOp out= kwarg must be an array not type %s",
  ...
  if (Py_SIZE(args) > 1) {
    ...
    if (PyLong_CheckExact(funcNumber)) {
      ...
      if (IsFastArrayOrNumpy(inObject)) {
        PyObject *result = ProcessOneInput(inObject, NULL, (int)funcNum,
                                           PyArray_TYPE(inObject), -1);
        return result;
      } else {

        PyErr_Format(
            PyExc_ValueError,
            "BasicMathUnaryOp first argument must be an array not type %s",
            ((PyObject *)inObject)->ob_type->tp_name);
      }
    } else {
      PyErr_Format(
          PyExc_ValueError,
          "BasicMathUnaryOp second argument must be an integer not type %s",
          funcNumber->ob_type->tp_name);
    }
  } else {
    PyErr_Format(PyExc_ValueError,
                 "BasicMathUnaryOp must have at least two arguments");
  }
