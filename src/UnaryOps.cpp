        ...
        if (pUnaryFunc)
        {
            ...
            if (outputArray)
            {
                ...
                if (pWorkItem == NULL)
                {
                    ...
                    // main thread
                    pUnaryFunc(pDataIn, pDataOut, len, strideIn, static_cast<int32_t>(PyArray_ITEMSIZE(outputArray)));
                }
                else
                {
                    ...
                    stCallback.itemSizeOut = static_cast<int32_t>(PyArray_ITEMSIZE(outputArray));
