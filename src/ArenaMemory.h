...
struct  SFW_ALIGN(16) LF_SLIST {
   ...
   // Because of CompareExchange128 syntax, we use unions to clarify which part of the struct
   // is (128 bit compare) vs (the high 64 bit compare and the low 64 bit compare)
   union {
...
// Returns number of elements in Q. It is a snapshot that might change immediately.
