...
// TODO: Remove these includes, they don't seem to be used anymore (at least
...
//#warning Unable to determine how to perform aligned allocations on this
//platform.
...
typedef double (*ANY_SCATTER_GATHER_FUNC)(
    void *pDataIn, int64_t len, stScatterGatherFunc *pstScatterGatherFunc);

// typedef void(*UNARY_FUNC)(void* pDataIn, void* pDataOut, int64_t len);
typedef void (*UNARY_FUNC)(void *pDataIn, void *pDataOut, int64_t len,
                           int64_t strideIn, int64_t strideOut);
typedef void (*UNARY_FUNC_STRIDED)(void *pDataIn, void *pDataOut, int64_t len,
                                   int64_t strideIn, int64_t strideOut);
...
// typedef void(*MERGE_TWO_FUNC)(void* pDataIn, void* pDataIn2, void* pDataOut,
// int64_t valSize, int64_t start, int64_t len, void* pDefault);
...
typedef void (*GROUPBY_TWO_FUNC)(void *pDataIn, void *pIndex,
                                 int32_t *pCountOut, void *pDataOut,
                                 int64_t len, int64_t binLow, int64_t binHigh,
                                 int64_t pass);

// Used for Groupby Mode/Median/etc
typedef void (*GROUPBY_X_FUNC32)(void *pColumn, void *pGroup, int32_t *pFirst,
                                 int32_t *pCount, void *pAccumBin,
                                 int64_t binLow, int64_t binHigh,
                                 int64_t totalInputRows, int64_t itemSize,
                                 int64_t funcParam);
typedef void (*GROUPBY_X_FUNC64)(void *pColumn, void *pGroup, int64_t *pFirst,
                                 int64_t *pCount, void *pAccumBin,
                                 int64_t binLow, int64_t binHigh,
                                 int64_t totalInputRows, int64_t itemSize,
                                 int64_t funcParam);
...
typedef void (*ANY_THREE_FUNC)(void *pDataIn, void *pDataIn2, void *pDataIn3,
                               void *pDataOut, int64_t len, int32_t scalarMode);
...
// Adding two numbers and then writing the results is 2xREAD and 1xWRITE ==>
// 300MB total in 0.05 seconds 300MB * 20 = 6GB/sec bandwidth Bit count stuff
// Output is int8_t
...
#define RETURN_NONE                                                            \
  Py_INCREF(Py_None);                                                          \
  return Py_None;
#define STRIDE_NEXT(_TYPE_, _MEM_, _STRIDE_)                                   \
  (_TYPE_ *)((char *)_MEM_ + _STRIDE_)
