...
static
PyObject* ConvertFloat64(PyObject* object) {
...
// arg1: the list or item to be converted to an array
static
PyObject* ConvertBool(PyObject* object) {
   npy_intp size = Py_SIZE(object);
...
PyObject* ConvertUnicode(PyObject* object) {
   ...
   for (INT64 i = 0; i < size; i++) {
      ...
      // zero out rest
      if (strSize < maxsize) pDest[strSize] = 0;
...
AsAnyArray(PyObject *self, PyObject *args, PyObject *kwargs) {
   ...
   if (descr == NULL) {
      ...
      if (PyList_Check(object)) {
         ...
         //bool isscalar = PyObject_TypeCheck((PyArrayObject*)object, &PyGenericArrType_Type);
