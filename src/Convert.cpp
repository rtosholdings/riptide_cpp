...
#define _mm256_extract_epi64(a, imm8)                                          \
  _mm_extract_epi64(_mm256_extracti128_si256((a), imm8 / 2), imm8 % 2)
...
typedef void (*CONVERT_SAFE)(void *pDataIn, void *pDataOut, int64_t len,
                             void *pBadInput1, void *pBadOutput1,
                             int64_t strideIn, int64_t strideOut);
typedef void (*MASK_CONVERT_SAFE)(void *pDataIn, void *pDataOut, int8_t *pMask,
                                  int64_t len, void *pBadInput1,
                                  void *pBadOutput1);
typedef void (*CONVERT_SAFE_STRING)(void *pDataIn, void *pDataOut, int64_t len,
                                    int64_t inputItemSize,
                                    int64_t outputItemSize);

static void ConvertSafeStringCopy(void *pDataIn, void *pDataOut, int64_t len,
                                  int64_t inputItemSize,
                                  int64_t outputItemSize) {
...
template <typename T, typename U> class ConvertBase {
public:
  ConvertBase(){};
  ~ConvertBase(){};

  static void PutMaskFast(void *pDataIn, void *pDataOut, int8_t *pMask,
                          int64_t len, void *pBadInput1, void *pBadOutput1) {
    T *pIn = (T *)pDataIn;
    T *pOut = (T *)pDataOut;
  ...
  static void PutMaskCopy(void *pDataIn, void *pDataOut, int8_t *pMask,
                          int64_t len, void *pBadInput1, void *pBadOutput1) {
    T *pIn = (T *)pDataIn;
    U *pOut = (U *)pDataOut;
  ...
  static void PutMaskCopyBool(void *pDataIn, void *pDataOut, int8_t *pMask,
                              int64_t len, void *pBadInput1,
                              void *pBadOutput1) {
    T *pIn = (T *)pDataIn;
    U *pOut = (U *)pDataOut;
  ...
  static void PutMaskCopyFloat(void *pDataIn, void *pDataOut, int8_t *pMask,
                               int64_t len, void *pBadInput1,
                               void *pBadOutput1) {
    T *pIn = (T *)pDataIn;
    U *pOut = (U *)pDataOut;
  ...
  static void OneStubConvert(void *pDataIn, void *pDataOut, int64_t len,
                             int64_t strideIn, int64_t strideOut) {
  ...
  static void OneStubConvertSafeCopy(void *pDataIn, void *pDataOut, int64_t len,
                                     void *pBadInput1, void *pBadOutput1,
                                     int64_t strideIn, int64_t strideOut) {
  ...
  static void OneStubConvertUnsafe(void *pDataIn, void *pDataOut, int64_t len,
                                   void *pBadInput1, void *pBadOutput1,
                                   int64_t strideIn, int64_t strideOut) {
  ...
  static void OneStubConvertSafe(void *pDataIn, void *pDataOut, int64_t len,
                                 void *pBadInput1, void *pBadOutput1,
                                 int64_t strideIn, int64_t strideOut) {
  ...
  static void OneStubConvertSafeFloatToDouble(void *pDataIn, void *pDataOut,
                                              int64_t len, void *pBadInput1,
                                              void *pBadOutput1,
                                              int64_t strideIn,
                                              int64_t strideOut) {
    ...
    if (strideIn == sizeof(float) && strideOut == sizeof(double)) {
      ...
      while (pOut <= pEndOut8) {
        ...
        _mm256_storeu_pd(pOut + 4,
                         _mm256_cvtps_pd(_mm256_extractf128_ps(m0, 1)));
        pOut += 8;
        pIn += 8;
      }
      while (pOut != pEndOut) {
  ...
  static void OneStubConvertSafeDoubleToFloat(void *pDataIn, void *pDataOut,
                                              int64_t len, void *pBadInput1,
                                              void *pBadOutput1,
                                              int64_t strideIn,
                                              int64_t strideOut) {
  ...
  static void OneStubConvertSafeFloat(void *pDataIn, void *pDataOut,
                                      int64_t len, void *pBadInput1,
                                      void *pBadOutput1, int64_t strideIn,
                                      int64_t strideOut) {
  ...
  static void OneStubConvertSafeBool(void *pDataIn, void *pDataOut, int64_t len,
                                     void *pBadInput1, void *pBadOutput1,
                                     int64_t strideIn, int64_t strideOut) {
  ...
  static void OneStubConvertBool(void *pDataIn, void *pDataOut, int64_t len,
                                 int64_t strideIn, int64_t strideOut) {
...
template <typename T> static UNARY_FUNC GetConversionStep2(int outputType) {
  switch (outputType) {
  case NPY_BOOL:
...
static bool ConvertThreadCallback(struct stMATH_WORKER_ITEM *pstWorkerItem,
                                  int core, int64_t workIndex) {
  bool didSomeWork = false;
  CONVERT_CALLBACK *Callback =
      (CONVERT_CALLBACK *)pstWorkerItem->WorkCallbackArg;
  ...
  while ((lenX = pstWorkerItem->GetNextWorkBlock(&workBlock)) > 0) {
    ...
    Callback->anyConvertCallback(pDataIn + inputAdj, pDataOut + outputAdj, lenX,
                                 Callback->pBadInput1, Callback->pBadOutput1,
...
PyObject *ConvertSafeInternal(PyArrayObject *const inArr1,
  ...
  PyArrayObject *outArray = AllocateNumpyArray(ndim, dims, numpyOutType, 0,
                                               PyArray_IS_F_CONTIGUOUS(inArr1));
  ...
  if (directionIn != 0 || directionOut != 0) {
    ...
    if (directionIn == 1 && directionOut == 0) {
      ...
      for (int64_t j = 0; j < outerLen; j++) {
        pFunction((char *)pDataIn + (j * outerStride),
                  (char *)pDataOut + (j * innerLen * strideOut), innerLen,
                  pBadInput1, pBadOutput1, strideIn, strideOut);
      }
      ...
      outArray =
          (PyArrayObject *)PyArray_FROM_OT((PyObject *)inArr1, numpyOutType);
    ...
    if (!pWorkItem) {
      ...
      // thread
      pFunction(pDataIn, pDataOut, len, pBadInput1, pBadOutput1, strideIn,
                strideOut);
    } else {
    ...
    if (PyLong_CheckExact(inNumber)) {
      ...
      if (IsFastArrayOrNumpy(inObject)) {
        ...
        PyErr_Format(PyExc_ValueError,
                     "ConvertSafe first argument must be an array not type %s",
                     ((PyObject *)inObject)->ob_type->tp_name);
      }
    } else {
      PyErr_Format(PyExc_ValueError,
                   "ConvertSafe second argument must be an integer not type %s",
                   inNumber->ob_type->tp_name);
    }
  } else {
    PyErr_Format(PyExc_ValueError,
                 "ConvertSafe must have at least two arguments");
  }
...
PyObject *ConvertUnsafeInternal(PyArrayObject *inArr1, int64_t out_dtype) {
  ...
  if (numpyOutType < 0 || numpyInType < 0 || numpyInType > NPY_LONGDOUBLE ||
      numpyOutType > NPY_LONGDOUBLE) {
    return PyErr_Format(
        PyExc_ValueError,
        "ConvertUnsafe: Don't know how to convert these types %d %d",
        numpyInType, numpyOutType);
  }

  // TODO: Do we still need the check above? Or can we just rely on
  // GetConversionFunctionUnsafe() to do any necessary checks?
  CONVERT_SAFE pFunction =
      GetConversionFunctionUnsafe(numpyInType, numpyOutType);
  if (!pFunction) {
    return PyErr_Format(
        PyExc_ValueError,
        "ConvertUnsafe: Don't know how to convert these types %d %d",
  ...
  if (!pWorkItem) {
    // Threading not allowed for this work item, call it directly from main
    // thread
    pFunction(pDataIn, pDataOut, len, pBadInput1, pBadOutput1,
              PyArray_STRIDE(inArr1, 0), PyArray_STRIDE(outArray, 0));
  } else {
    // Each thread will call this routine with the callbackArg
    pWorkItem->DoWorkCallback = ConvertThreadCallback;
    pWorkItem->WorkCallbackArg = &stConvertCallback;
...
PyObject *ConvertUnsafe(PyObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "O!L:ConvertUnsafe", &PyArray_Type, &inArr1,
                        &out_dtype)) {
...
// MASK------------------------------------------------------------------------
//=====================================================================================
typedef void (*COMBINE_MASK)(void *pDataIn, void *pDataOut, int64_t len,
                             int8_t *pFilter);

template <typename T>
static void CombineMask(void *pDataInT, void *pDataOutT, int64_t len,
                        int8_t *pFilter) {
...
//------------------------------------------------------------------------------
//  Concurrent callback from multiple threads
static bool CombineThreadCallback(struct stMATH_WORKER_ITEM *pstWorkerItem,
                                  int core, int64_t workIndex) {
  bool didSomeWork = false;
  COMBINE_CALLBACK *Callback =
      (COMBINE_CALLBACK *)pstWorkerItem->WorkCallbackArg;
  ...
  while ((lenX = pstWorkerItem->GetNextWorkBlock(&workBlock)) > 0) {
    ...
    Callback->anyCombineCallback(pDataIn + inputAdj, pDataOut + inputAdj, lenX,
                                 Callback->pFilter + filterAdj);
...
PyObject *CombineFilter(PyObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "O!O!:CombineFilter", &PyArray_Type, &inArr1,
  ...
  if (arraySize1 != ArrayLength(inFilter)) {
    PyErr_Format(PyExc_ValueError,
                 "CombineFilter: Filter size not the same %lld", arraySize1);
    return NULL;
  }

  if (PyArray_TYPE(inFilter) != NPY_BOOL) {
    PyErr_Format(PyExc_ValueError,
                 "CombineFilter: Filter is not type NPY_BOOL");
    return NULL;
  }
  ...
  PyErr_Format(PyExc_ValueError, "Dont know how to combine these types %d",
               numpyOutType);
  return NULL;
}
...
// MASK----------------------------------------------------------------
//=====================================================================================
typedef void (*COMBINE_ACCUM2_MASK)(void *pDataIn1, void *pDataIn2,
                                    void *pDataOut, const int64_t multiplier,
                                    const int64_t maxbin, int64_t len,
                                    void *pCountOut2, int8_t *pFilter);

template <typename T, typename U, typename V>
static void CombineAccum2Mask(void *pDataIn1T, void *pDataIn2T, void *pDataOutT,
                              const int64_t multiplier, const int64_t maxbinT,
                              int64_t len, void *pCountOut2, int8_t *pFilter) {
...
//  Concurrent callback from multiple threads
static bool
CombineThreadAccum2Callback(struct stMATH_WORKER_ITEM *pstWorkerItem, int core,
                            int64_t workIndex) {
  bool didSomeWork = false;
  COMBINE_ACCUM2_CALLBACK *Callback =
      (COMBINE_ACCUM2_CALLBACK *)pstWorkerItem->WorkCallbackArg;
  ...
  while ((lenX = pstWorkerItem->GetNextWorkBlock(&workBlock)) > 0) {
    ...
    int64_t inputAdj1 =
        pstWorkerItem->BlockSize * workBlock * Callback->typeSizeIn1;
    int64_t inputAdj2 =
        pstWorkerItem->BlockSize * workBlock * Callback->typeSizeIn2;
    int64_t outputAdj =
        pstWorkerItem->BlockSize * workBlock * Callback->typeSizeOut;
    int64_t filterAdj = pstWorkerItem->BlockSize * workBlock;
    ...
    Callback->anyCombineCallback(
        pDataIn1 + inputAdj1, pDataIn2 + inputAdj2, pDataOut + outputAdj,
        Callback->multiplier, Callback->maxbin, lenX,
        // based on core, pick a counter
        // TODO: 64bit code also
        Callback->pCountWorkSpace
            ? &((int32_t *)(Callback->pCountWorkSpace))[(core + 1) *
                                                        Callback->maxbin]
            : NULL,
...
PyObject *CombineAccum2Filter(PyObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "O!O!LLO:CombineAccum2Filter", &PyArray_Type,
                        &inArr1, &PyArray_Type, &inArr2, &inArr1Max, &inArr2Max,
                        &inFilter)) {
  ...
  if (arraySize1 != arraySize2) {
    PyErr_Format(PyExc_ValueError,
                 "CombineAccum2Filter: array sizes not the same %lld",
                 arraySize1);
    return NULL;
  }
  ...
  if (PyArray_Check(inFilter)) {
    if (arraySize1 != ArrayLength((PyArrayObject *)inFilter)) {
      PyErr_Format(PyExc_ValueError,
                   "CombineAccum2Filter: Filter size not the same %lld",
                   arraySize1);
      return NULL;
    }
    if (PyArray_TYPE((PyArrayObject *)inFilter) != NPY_BOOL) {
      PyErr_Format(PyExc_ValueError,
                   "CombineAccum2Filter: Filter is not type NPY_BOOL");
      return NULL;
    }
  ...
  if (hashSize < 0) {
    PyErr_Format(PyExc_ValueError,
                 "CombineAccum2Filter: Index sizes are negative %lld",
                 hashSize);
    return NULL;
  }
  ...
  if (pFunction != NULL) {
    PyArrayObject *outArray = AllocateNumpyArray(
        ndim, dims, numpyOutType, 0, PyArray_IS_F_CONTIGUOUS(inArr1));
    CHECK_MEMORY_ERROR(outArray);
    ...
    if (outArray) {
      ...
      if (bWantCount) {
        countArray = AllocateNumpyArray(1, (npy_intp *)&hashSize,
                                        is64bithash ? NPY_INT64 : NPY_INT32);
      ...
      if (pWorkItem == NULL) {
        ...
        LOGGING("**array: %lld      out sizes: %lld %lld %lld\n", arraySize1,
                stCombineAccum2Callback.typeSizeIn1,
                stCombineAccum2Callback.typeSizeIn2,
                stCombineAccum2Callback.typeSizeOut);
...
PyObject *CombineAccum1Filter(PyObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "O!LO:CombineAccum1Filter", &PyArray_Type,
                        &inArr1, &inArr1Max, &inFilter)) {
  ...
  if (PyArray_Check(inFilter)) {
    if (arraySize1 != ArrayLength((PyArrayObject *)inFilter)) {
      PyErr_Format(PyExc_ValueError,
                   "CombineAccum1Filter: Filter size not the same %lld",
                   arraySize1);
      return NULL;
    }
    if (PyArray_TYPE((PyArrayObject *)inFilter) != NPY_BOOL) {
      PyErr_Format(PyExc_ValueError,
                   "CombineAccum1Filter: Filter is not type NPY_BOOL");
      return NULL;
    }
    pFilterIn = (int8_t *)PyArray_BYTES((PyArrayObject *)inFilter);
  }
  ...
  if (pFunction != NULL) {
    PyArrayObject *outArray = AllocateNumpyArray(
        ndim, dims, dtype, 0, PyArray_IS_F_CONTIGUOUS(inArr1));
    CHECK_MEMORY_ERROR(outArray);

    PyArrayObject *firstArray = AllocateNumpyArray(
        1, (npy_intp *)&arraySize1,
    ...
    if (outArray && firstArray) {
      ...
      int64_t uniqueCount = pFunction(pDataIn1, PyArray_BYTES(outArray), pFirst,
                                      pFilterIn, arraySize1, hashSize);

      if (uniqueCount < arraySize1) {
        // fixup first to hold only the uniques
        PyArrayObject *firstArrayReduced = AllocateNumpyArray(
            1, (npy_intp *)&uniqueCount,
            NPY_INT32); // TODO: bump up to int64_t for large arrays
      ...
      PyList_SET_ITEM(returnObject, 2,
                      (PyObject *)PyLong_FromLongLong(uniqueCount));
      return returnObject;
    }
  }
...
PyObject *MakeiFirst(PyObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "O!LOL:MakeiFirst", &PyArray_Type, &inArr1,
                        &inArr1Max, &inFilter, &isLast)) {
  ...
  if (PyArray_Check(inFilter)) {
    if (arraySize1 != ArrayLength((PyArrayObject *)inFilter)) {
      PyErr_Format(PyExc_ValueError,
                   "MakeiFirst: Filter size not the same %lld", arraySize1);
      return NULL;
    }
    if (PyArray_TYPE((PyArrayObject *)inFilter) != NPY_BOOL) {
  ...
  if (pFunction != NULL) {
    PyArrayObject *firstArray =
        AllocateNumpyArray(1, (npy_intp *)&hashSize, NPY_INT64);
    CHECK_MEMORY_ERROR(firstArray);
    ...
    if (firstArray) {
      ...
      int64_t uniqueCount =
          pFunction(pDataIn1, pFirst, pFilterIn, arraySize1, hashSize);
...
//=====================================================================================
//
void TrailingSpacesUnicode(uint32_t *pUnicodeArray, int64_t length,
                           int64_t itemSize) {
  itemSize = itemSize / 4;
...
PyObject *GetUpcastNum(PyObject *self, PyObject *args) {
  ...
  // Do not copy
  ArrayInfo *aInfo =
      BuildArrayInfo(inList1, &tupleSize, &totalItemSize, false, false);
...
PyObject *HStack(PyObject *self, PyObject *args) {
  ...
  if (aInfo) {
    ...
    if (dtype == NPY_STRING || dtype == NPY_UNICODE) {
      ...
      stHSTACK_STRING *pHStack = (stHSTACK_STRING *)WORKSPACE_ALLOC(
          sizeof(stHSTACK_STRING) * tupleSize);
      ...
      if (dtype == NPY_STRING || dtype == NPY_UNICODE) {
        // string allocation
        outputArray =
            AllocateNumpyArray(1, (npy_intp *)&totalLength, dtype, maxItemSize);
      } else {
      ...
      if (outputArray) {
        ...
        if (tupleSize < 2 || totalLength <= g_cMathWorker->WORK_ITEM_CHUNK) {
          ...
          for (int t = 0; t < tupleSize; t++) {
            pHStack[t].ConvertSafeString(
                aInfo[t].pData, pOutput + (pHStack[t].Offset * itemSize),
          ...
          auto lambdaHSCallback = [](void *callbackArgT, int core,
            ...
            callbackArg->pHStack[t].ConvertSafeString(
                ...
                callbackArg->pOutput + (callbackArg->pHStack[t].Offset *
                                        callbackArg->ItemSizeOutput),
                callbackArg->aInfo[t].ArrayLength,
                callbackArg->aInfo[t].ItemSize, callbackArg->ItemSizeOutput);

            return true;
          };

          g_cMathWorker->DoMultiThreadedWork((int)tupleSize, lambdaHSCallback,
                                             &myhstack);
        }
      }
      ...
      stHSTACK *pHStack =
          (stHSTACK *)WORKSPACE_ALLOC(sizeof(stHSTACK) * tupleSize);
      ...
      for (int t = 0; t < tupleSize; t++) {
        ...
        pHStack[t].ConvertSafe =
            GetConversionFunctionSafe(aInfo[t].NumpyDType, dtype);
        pHStack[t].Offset = totalLength;
        ...
        if (tupleSize < 2 || totalLength <= g_cMathWorker->WORK_ITEM_CHUNK) {
          ...
          for (int t = 0; t < tupleSize; t++) {
            pHStack[t].ConvertSafe(
                ...
                aInfo[t].ArrayLength, pHStack[t].pBadInput1, pBadOutput1,
                PyArray_STRIDE(aInfo[t].pObject, 0), strideOut);
          }
        } else {
          ...
          auto lambdaHSCallback = [](void *callbackArgT, int core,
            ...
            callbackArg->pHStack[t].ConvertSafe(
                callbackArg->aInfo[t].pData,
                callbackArg->pOutput +
                    (callbackArg->pHStack[t].Offset * callbackArg->StrideOut),
                callbackArg->aInfo[t].ArrayLength,
                callbackArg->pHStack[t].pBadInput1, callbackArg->pBadOutput1,
...
PyObject *ShiftArrays(PyObject *self, PyObject *args) {
  ...
  if (aInfo) {
    ...
    auto lambdaShiftCallback = [](void *callbackArgT, int core,
                                  int64_t workIndex) -> bool {
      ...
      if (pArrayInfo->pData) {
        ...
        if (pArrayInfo->NDim >= 2 && pStrides[0] < pStrides[1]) {
          ...
          if (deltaShift > 0) {
            ...
            if (pShift->shiftAmount < 0) {
              char *pTop2 =
                  pTop1 - (pShift->shiftAmount * pArrayInfo->ItemSize);
    ...
    g_cMathWorker->DoMultiThreadedWork((int)tupleSize, lambdaShiftCallback,
                                       &myshift);
...
PyObject *HomogenizeArrays(PyObject *self, PyObject *args) {
  if (!PyTuple_Check(args)) {
    PyErr_Format(PyExc_ValueError,
                 "HomogenizeArrays arguments needs to be a tuple");
    return NULL;
  }
  ...
  if (argTupleSize < 2) {
    PyErr_Format(PyExc_ValueError,
                 "HomogenizeArrays requires two args instead of %llu args",
                 argTupleSize);
    return NULL;
  }
  ...
  if (aInfo) {
    ...
    for (int t = 0; t < tupleSize; t++) {
      ...
      if (dtype != aInfo[t].NumpyDType) {
        ...
        PyArrayObject *pOutput =
            AllocateLikeNumpyArray(aInfo[t].pObject, dtype);

        // TODO: multithread this
        if (pOutput) {
          // preserve sentinels
          convertSafe(aInfo[t].pData, PyArray_BYTES(pOutput),
                      aInfo[t].ArrayLength, pBadInput1, pBadOutput1,
...
int64_t SumBooleanMask(const int8_t *const pData, const int64_t length) {
  ...
  for (size_t i = 0; i < vector_length;) {
    ...
    for (size_t j = 0; j < inner_loop_iters; j++) {
      ...
      // value.
      const auto cstyle_bools =
          _mm256_min_epu8(ones, _mm256_loadu_si256(&pVectorData[i + j]));
    ...
    const auto byte_popcounts_16 =
        _mm256_add_epi16(byte_popcounts_8a, byte_popcounts_8b);

    // Sum 16x 2-byte counts -> 8x 4-byte counts
    const auto byte_popcounts_16a =
        _mm256_unpacklo_epi16(byte_popcounts_16, zeros);
    const auto byte_popcounts_16b =
        _mm256_unpackhi_epi16(byte_popcounts_16, zeros);
    const auto byte_popcounts_32 =
        _mm256_add_epi32(byte_popcounts_16a, byte_popcounts_16b);

    // Sum 8x 4-byte counts -> 4x 8-byte counts
    const auto byte_popcounts_32a =
        _mm256_unpacklo_epi32(byte_popcounts_32, zeros);
    const auto byte_popcounts_32b =
        _mm256_unpackhi_epi32(byte_popcounts_32, zeros);
    const auto byte_popcounts_64 =
        _mm256_add_epi64(byte_popcounts_32a, byte_popcounts_32b);

    // Sum 4x 8-byte counts -> 1x 32-byte count.
    const auto byte_popcount_256 = _mm256_extract_epi64(byte_popcounts_64, 0) +
...
void CopyItemBooleanMask(void *pSrcV, void *pDestV, int8_t *pBoolMask,
                         int64_t arrayLength, int64_t itemsize) {
  switch (itemsize) {
...
void CopyItemBooleanMaskScalar(void *pSrcV, void *pDestV, int8_t *pBoolMask,
                               int64_t arrayLength, int64_t itemsize) {
  switch (itemsize) {
...
//--------------------------------------------------------------------------
//
PyObject *SetItemBooleanMask(PyArrayObject *arr, PyArrayObject *mask,
                             PyArrayObject *inValues, int64_t arrayLength) {
  ...
  if (bsum > 0 && bsum == ArrayLength(inValues)) {
    ...
    CopyItemBooleanMask(pSrc, pDest, pBoolMask, arrayLength,
...
PyObject *SetItemBooleanMaskLarge(PyArrayObject *arr, PyArrayObject *mask,
  ...
  stBoolCounter.sections =
      (stBoolCounter.maskLength + (SETITEM_PARTITION_SIZE - 1)) /
      SETITEM_PARTITION_SIZE;
  ...
  if (stBoolCounter.pCounts) {
    ...
    auto lambdaCallback = [](void *callbackArgT, int core,
                             int64_t workIndex) -> bool {
      ...
      pstBoolCounter->pCounts[workIndex] = SumBooleanMask(
    ...
    g_cMathWorker->DoMultiThreadedWork((int)stBoolCounter.sections,
                                       lambdaCallback, &stBoolCounter);
    ...
    if (bsum > 0 && bsum == arrlength) {
      ...
      auto lambda2Callback = [](void *callbackArgT, int core,
                                int64_t workIndex) -> bool {
        ST_BOOLCOUNTER *pstBoolCounter = (ST_BOOLCOUNTER *)callbackArgT;
        int64_t t = workIndex;
        ...
        int64_t adjustment =
            (SETITEM_PARTITION_SIZE * workIndex * pstBoolCounter->itemSize);
        CopyItemBooleanMask(
            pstBoolCounter->pSrc +
                (pstBoolCounter->pCounts[workIndex] * pstBoolCounter->itemSize),
            pstBoolCounter->pDest + adjustment,
            pstBoolCounter->pBoolMask + (SETITEM_PARTITION_SIZE * workIndex),
            lastCount, pstBoolCounter->itemSize);

        return true;
      };

      g_cMathWorker->DoMultiThreadedWork((int)stBoolCounter.sections,
                                         lambda2Callback, &stBoolCounter);
    ...
    if (bsum > 0 && arrlength == 1) {
      ...
      auto lambda2Callback = [](void *callbackArgT, int core,
        ...
        CopyItemBooleanMaskScalar(
            pstBoolCounter->pSrc, pstBoolCounter->pDest + adjustment,
            pstBoolCounter->pBoolMask + (SETITEM_PARTITION_SIZE * workIndex),
            lastCount, pstBoolCounter->itemSize);
...
PyObject *SetItem(PyObject *self, PyObject *args) {
  ...
  if (argTupleSize < 3) {
    PyErr_Format(PyExc_ValueError,
                 "SetItem requires three args instead of %llu args",
                 argTupleSize);
    return NULL;
  }
  ...
  if (value) {
    if (PyArray_Check(arr) && PyArray_Check(mask) && PyArray_Check(value)) {
      ...
      if (PyArray_NDIM(arr) == 1 && PyArray_ITEMSIZE(arr) > 0 &&
    ...
    LOGGING("SetItem Could not convert value to array %d  %lld  %d  %lld\n",
            ...
            PyArray_NDIM((PyArrayObject *)value),
            PyArray_ITEMSIZE((PyArrayObject *)value));
  } else {
...
PyObject *PutMask(PyObject *self, PyObject *args) {
  ...
  if (PyArray_Check(arr) && PyArray_Check(mask) && PyArray_Check(value)) {
    ...
    if (PyArray_TYPE(mask) == NPY_BOOL) {
      ...
      int64_t arrayLength = ArrayLength(arr);
      if (arrayLength == ArrayLength(mask) &&
          itemSizeOut == PyArray_STRIDE(arr, 0)) {
        ...
        if (arrayLength == valLength) {
          ...
          if (maskSafe) {
            ...
            // threads
            auto lambdaMaskCallback = [](void *callbackArgT, int core,
                                         int64_t start,
                                         int64_t length) -> bool {
              MASK_CALLBACK_STRUCT *callbackArg =
            ...
            g_cMathWorker->DoMultiThreadedChunkWork(
                arrayLength, lambdaMaskCallback, &stMask);
...
PyObject *ApplyRows(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (argTupleSize < 2) {
    PyErr_Format(PyExc_ValueError,
                 "ApplyRows requires two args instead of %llu args",
                 argTupleSize);
    return NULL;
  }
  ...
  if (!PyCallable_Check(arg1)) {
    ...
    PyErr_Format(PyExc_ValueError,
                 "Argument must be a function or a method not %s\n",
                 type->tp_name);
    return NULL;
  }
  ...
  if (function) {
    ...
    // Do not allow jagged rows
    ArrayInfo *aInfo =
        BuildArrayInfo(inList1, &tupleSize, &totalItemSize, true);
