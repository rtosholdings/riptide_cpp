...
public:
  ...
  bool Open(const char *fileName, bool writeOption = false,
            bool overlapped = false, bool directIO = false);
  ...
  DWORD ReadChunkAsync(void *buffer, UINT32 count, DWORD *lastError,
  ...
  DWORD WriteChunkAsync(void *buffer, UINT32 count, DWORD *lastError,
                        OVERLAPPED *pOverlapped, bool bWaitOnIO = false);
