...
void calculate_for_active_operation( char const * in_p, char * out_p, ptrdiff_t & starting_element, int64_t const in_array_stride,
                                     size_t contig_elems, operation_variant const & requested_op, data_type const * type_p,
...
void calculate_for_active_data_type( char const * in_p, char * out_p, ptrdiff_t & starting_element, int64_t const in_array_stride,
                                     size_t contig_elems, operation_t const & requested_op, type_variant const & in_type,
                                     std::index_sequence< Is... > )
{
...
void walk_data_array( ptrdiff_t inner_len, size_t outer_len, ptrdiff_t outer_stride, ptrdiff_t stride_out, char const * in_p,
                      char * out_p, operation_trait const & requested_op, type_trait const & in_type )
{
    ptrdiff_t offset{};
