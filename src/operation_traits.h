...
template <typename arithmetic_concept, typename simd_concept,
          typename bitmask_concept, typename Enable = void>
struct data_type_traits {};

template <typename arithmetic_concept, typename simd_concept,
          typename bitmask_concept>
struct data_type_traits<
    arithmetic_concept, simd_concept, bitmask_concept,
...
using data_type_t =
    std::variant<int8_traits, int16_traits, int32_traits, int64_traits,
                 uint8_traits, uint16_traits, uint32_traits, uint64_traits,
                 float_traits, double_traits>;
...
using operation_t =
    std::variant<abs_op, fabs_op, sign_op, floatsign_op, neg_op, bitwise_not_op,
                 not_op, isnotnan_op, isnan_op, isfinite_op, isnotfinite_op,
                 isinf_op, isnotinf_op, isnormal_op, isnotnormal_op,
                 isnanorzero_op, round_op, floor_op, trunc_op, ceil_op, sqrt_op,
                 log_op, log2_op, log10_op, exp_op, exp2_op, cbrt_op, tan_op,
                 cos_op, sin_op, signbit_op>;
