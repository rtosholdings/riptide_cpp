...
rc_module = None
sources_cpp=['one_input.cpp','UnaryOps.cpp','RipTide.cpp','Recycler.cpp','BasicMath.cpp','HashFunctions.cpp','HashLinear.cpp', 'MathThreads.cpp', 'Sort.cpp',
            'Compare.cpp', 'MultiKey.cpp', 'MathWorker.cpp', 'BitCount.cpp', 'GroupBy.cpp','Ema.cpp','Reduce.cpp',
...
if sys.platform == 'linux':
    rc_module = setuptools.Extension(
        ...
        extra_compile_args = ['-mavx2', '-mbmi2', '-fpermissive','-Wno-unused-variable','-Wno-ignored-attributes','-std=c++17','-pthread','-falign-functions=32','-falign-loops=32','-fno-strict-aliasing'],
        extra_link_args = ['-lrt'],
        #libraries = [''],
        )
...
if sys.platform == 'darwin':
    rc_module = setuptools.Extension(
        ...
        #libraries = ['libzstd.a'],
        #library_dirs = ['lib'],
        extra_compile_args = ['-mavx2', '-mbmi2', '-fpermissive','-Wno-unused-variable','-std=c++17','-pthread','-falign-functions=32','-fno-strict-aliasing'],
        )
