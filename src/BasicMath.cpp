...
template <typename T> static const inline bool AddOp(bool x, bool y) {
  return x | y;
}
template <typename T> static const inline T SubOp(T x, T y) { return x - y; }
template <typename T> static const inline bool SubOp(bool x, bool y) {
...
// nan > anynumber --> False
// nan < anynumber --> False
template <typename T> static const inline float MinOp(float x, float y) {
  if (x > y || y != y)
    return y;
  else
    return x;
}
template <typename T> static const inline double MinOp(double x, double y) {
  if (x > y || y != y)
    return y;
  else
    return x;
}
template <typename T> static const inline T MinOp(T x, T y) {
  if (x > y)
    return y;
  else
    return x;
...
template <typename T> static const inline float MaxOp(float x, float y) {
  if (x < y || y != y)
    return y;
  else
    return x;
}
template <typename T> static const inline double MaxOp(double x, double y) {
  if (x < y || y != y)
    return y;
  else
    return x;
}
template <typename T> static const inline T MaxOp(T x, T y) {
  if (x < y)
    return y;
  else
    return x;
...
template <typename T> static const inline double DivOp(T x, T y) {
  return (double)x / (double)y;
}
template <typename T> static const inline float DivOp(float x, T y) {
  return x / y;
}
...
template <typename T> static const inline float FloorDivOp(float x, float y) {
  if (y == y)
    return floorf(x / y);
  else
    return NAN;
...
template <typename T> static const inline T ModOp(T x, T y) { return x % y; }
template <typename T> static const inline float ModOp(T x, T y) {
  return fmodf(x, y);
}
template <typename T> static const inline double ModOp(T x, T y) {
  return fmod(x, y);
}
template <typename T> static const inline bool ModOp(bool x, bool y) {
  return (x ^ y);
}

template <typename T> static const inline T PowerOp(T x, T y) {
  return (T)pow(x, y);
}
template <typename T> static const inline float PowerOp(float x, float y) {
  return powf(x, y);
}
template <typename T> static const inline double PowerOp(double x, double y) {
  return pow(x, y);
}
template <typename T>
...
template <typename T> static const inline bool PowerOp(bool x, bool y) {
  if (!x & y)
    return 0;
  else
    return 1;
...
template <typename T> static const inline float REMAINDER_OP(float x, float y) {
...
template <typename T> static const inline double FMOD_OP(double x, double y) {
  return fmod(x, y);
}
template <typename T> static const inline float FMOD_OP(float x, float y) {
  return fmodf(x, y);
}

template <typename T> static const inline long double LogOp(long double x) {
  return logl(x);
}
template <typename T> static const inline double LogOp(double x) {
  return log(x);
}
template <typename T> static const inline float LogOp(float x) {
  return logf(x);
}
...
template <typename T> static const inline T AndNotOp(T x, T y) {
  return ~x & y;
}
...
FORCEINLINE void SimpleMathOpSlow(MathFunctionPtr MATH_OP, void *pDataIn1X,
                                  void *pDataIn2X, void *pDataOutX, int64_t len,
                                  int32_t scalarMode) {
...
template <typename T, typename MathFunctionPtr>
FORCEINLINE void SimpleMathOpSlowDouble(MathFunctionPtr MATH_OP,
                                        void *pDataIn1X, void *pDataIn2X,
                                        void *pDataOutX, int64_t len,
                                        int32_t scalarMode) {
...
template <typename T, typename U256, const T MATH_OP(T, T),
          const U256 MATH_OP256(U256, U256)>
inline void SimpleMathOpFast(void *pDataIn1X, void *pDataIn2X, void *pDataOutX,
                             int64_t datalen, int32_t scalarMode) {
  T *pDataOut = (T *)pDataOutX;
  T *pDataIn1 = (T *)pDataIn1X;
  T *pDataIn2 = (T *)pDataIn2X;
...
template <typename T, typename U256, const T MATH_OP(T, T),
          const U256 MATH_OP256(U256, U256)>
inline void SimpleMathOpFastReverse(void *pDataIn1X, void *pDataIn2X,
                                    void *pDataOutX, int64_t datalen,
                                    int32_t scalarMode) {
  return SimpleMathOpFast<T, U256, MATH_OP, MATH_OP256>(
      pDataIn2X, pDataIn1X, pDataOutX, datalen, scalarMode);
}
...
template <typename T, typename U256, const T MATH_OP(T, T),
          const U256 MATH_OP256(U256, U256)>
inline void SimpleMathOpFastSymmetric(void *pDataIn1X, void *pDataIn2X,
                                      void *pDataOutX, int64_t datalen,
                                      int32_t scalarMode) {
  T *pDataOut = (T *)pDataOutX;
  T *pDataIn1 = (T *)pDataIn1X;
...
template <typename T, typename U128, typename U256, typename MathFunctionPtr,
          typename MathFunctionConvert, typename MathFunctionPtr256>
inline void
SimpleMathOpFastDouble(MathFunctionPtr MATH_OP, MathFunctionConvert MATH_CONV,
                       MathFunctionPtr256 MATH_OP256, void *pDataIn1X,
                       void *pDataIn2X, void *pDataOutX, int64_t len,
                       int32_t scalarMode) {
  double *pDataOut = (double *)pDataOutX;
  T *pDataIn1 = (T *)pDataIn1X;
...
static void SimpleMathOpFastDivDouble(void *pDataIn1, void *pDataIn2,
                                      void *pDataOut, int64_t len,
                                      int32_t scalarMode) {
  return SimpleMathOpFastDouble<T, U128, U256, const double (*)(T, T),
                                const U256 (*)(U128 *),
                                const U256 (*)(U256, U256)>(
      DivOp<T>, CONV_INT32_DOUBLE, DIV_OP_256f64, pDataIn1, pDataIn2, pDataOut,
      len, scalarMode);
}
...
template <typename T>
static void SimpleMathOpSlowAdd(void *pDataIn1, void *pDataIn2, void *pDataOut,
                                int64_t len, int32_t scalarMode) {
  return SimpleMathOpSlow<T, const T (*)(T, T)>(AddOp<T>, pDataIn1, pDataIn2,
                                                pDataOut, len, scalarMode);
}

template <typename T>
static void SimpleMathOpSlowSub(void *pDataIn1, void *pDataIn2, void *pDataOut,
                                int64_t len, int32_t scalarMode) {
  return SimpleMathOpSlow<T, const T (*)(T, T)>(SubOp<T>, pDataIn1, pDataIn2,
                                                pDataOut, len, scalarMode);
}

template <typename T>
static void SimpleMathOpSlowMul(void *pDataIn1, void *pDataIn2, void *pDataOut,
                                int64_t len, int32_t scalarMode) {
  return SimpleMathOpSlow<T, const T (*)(T, T)>(MulOp<T>, pDataIn1, pDataIn2,
                                                pDataOut, len, scalarMode);
}

template <typename T>
static void SimpleMathOpSlowDivFloat(void *pDataIn1, void *pDataIn2,
                                     void *pDataOut, int64_t len,
                                     int32_t scalarMode) {
  return SimpleMathOpSlow<T, const float (*)(float, T)>(
      DivOp<T>, pDataIn1, pDataIn2, pDataOut, len, scalarMode);
}

template <typename T>
static void SimpleMathOpSlowDiv(void *pDataIn1, void *pDataIn2, void *pDataOut,
                                int64_t len, int32_t scalarMode) {
  return SimpleMathOpSlowDouble<T, const double (*)(T, T)>(
      DivOp<T>, pDataIn1, pDataIn2, pDataOut, len, scalarMode);
}

template <typename T>
static void SimpleMathOpSubDateTime(void *pDataIn1, void *pDataIn2,
                                    void *pDataOut, int64_t len,
                                    int32_t scalarMode) {
  return SimpleMathOpSlowDouble<T, const double (*)(T, T)>(
      SubDateTimeOp<T>, pDataIn1, pDataIn2, pDataOut, len, scalarMode);
}

template <typename T>
static void SimpleMathOpSubDates(void *pDataIn1, void *pDataIn2, void *pDataOut,
                                 int64_t len, int32_t scalarMode) {
  return SimpleMathOpSlow<T, const T (*)(T, T)>(
      SubDatesOp<T>, pDataIn1, pDataIn2, pDataOut, len, scalarMode);
}

template <typename T>
static void SimpleMathOpSlowFloorDiv(void *pDataIn1, void *pDataIn2,
                                     void *pDataOut, int64_t len,
                                     int32_t scalarMode) {
  return SimpleMathOpSlow<T, const T (*)(T, T)>(
      FloorDivOp<T>, pDataIn1, pDataIn2, pDataOut, len, scalarMode);
}

template <typename T>
static void SimpleMathOpSlowMod(void *pDataIn1, void *pDataIn2, void *pDataOut,
                                int64_t len, int32_t scalarMode) {
  return SimpleMathOpSlow<T, const T (*)(T, T)>(ModOp<T>, pDataIn1, pDataIn2,
                                                pDataOut, len, scalarMode);
}

template <typename T>
static void SimpleMathOpSlowLog(void *pDataIn1, void *pDataIn2, void *pDataOut,
                                int64_t len, int32_t scalarMode) {
  return SimpleMathOpSlow<T, const T (*)(T, T)>(LogOp<T>, pDataIn1, pDataIn2,
                                                pDataOut, len, scalarMode);
}

template <typename T>
static void SimpleMathOpSlowPower(void *pDataIn1, void *pDataIn2,
                                  void *pDataOut, int64_t len,
                                  int32_t scalarMode) {
  return SimpleMathOpSlow<T, const T (*)(T, T)>(PowerOp<T>, pDataIn1, pDataIn2,
                                                pDataOut, len, scalarMode);
}

template <typename T>
static void SimpleMathOpSlowRemainder(void *pDataIn1, void *pDataIn2,
                                      void *pDataOut, int64_t len,
                                      int32_t scalarMode) {
  return SimpleMathOpSlow<T, const T (*)(T, T)>(
      REMAINDER_OP<T>, pDataIn1, pDataIn2, pDataOut, len, scalarMode);
}

template <typename T>
static void SimpleMathOpSlowFmod(void *pDataIn1, void *pDataIn2, void *pDataOut,
                                 int64_t len, int32_t scalarMode) {
  return SimpleMathOpSlow<T, const T (*)(T, T)>(FMOD_OP<T>, pDataIn1, pDataIn2,
                                                pDataOut, len, scalarMode);
}

template <typename T>
static void SimpleMathOpSlowMin(void *pDataIn1, void *pDataIn2, void *pDataOut,
                                int64_t len, int32_t scalarMode) {
  return SimpleMathOpSlow<T, const T (*)(T, T)>(MinOp<T>, pDataIn1, pDataIn2,
                                                pDataOut, len, scalarMode);
}

template <typename T>
static void SimpleMathOpSlowMax(void *pDataIn1, void *pDataIn2, void *pDataOut,
                                int64_t len, int32_t scalarMode) {
  return SimpleMathOpSlow<T, const T (*)(T, T)>(MaxOp<T>, pDataIn1, pDataIn2,
                                                pDataOut, len, scalarMode);
}

static ANY_TWO_FUNC GetSimpleMathOpFast(int func, int scalarMode,
                                        int numpyInType1, int numpyInType2,
  ...
  case MATH_OPERATION::ADD:
    *wantedOutType = numpyInType1;
    ...
    case NPY_BOOL:
      return SimpleMathOpFastSymmetric<int8_t, __m256i, OrOp<int8_t>,
                                       OR_OP_256>;
    case NPY_FLOAT:
      return SimpleMathOpFastSymmetric<float, __m256, AddOp<float>,
                                       ADD_OP_256f32>;
    case NPY_DOUBLE:
      return SimpleMathOpFastSymmetric<double, __m256d, AddOp<double>,
                                       ADD_OP_256f64>;
      // proof of concept for i32 addition loop
    CASE_NPY_INT32:
      return SimpleMathOpFastSymmetric<int32_t, __m256i, AddOp<int32_t>,
                                       ADD_OP_256i32>;
    CASE_NPY_INT64:

      return SimpleMathOpFastSymmetric<int64_t, __m256i, AddOp<int64_t>,
                                       ADD_OP_256i64>;
    case NPY_INT16:
      return SimpleMathOpFastSymmetric<int16_t, __m256i, AddOp<int16_t>,
                                       ADD_OP_256i16>;
    case NPY_INT8:
      return SimpleMathOpFastSymmetric<int8_t, __m256i, AddOp<int8_t>,
                                       ADD_OP_256i8>;
    }
    return nullptr;
  ...
  case MATH_OPERATION::MUL:
    *wantedOutType = numpyInType1;
    ...
    switch (*wantedOutType) {
    case NPY_BOOL:
      return SimpleMathOpFastSymmetric<int8_t, __m256i, AndOp<int8_t>,
                                       AND_OP_256>;
    case NPY_FLOAT:
      return SimpleMathOpFastSymmetric<float, __m256, MulOp<float>,
                                       MUL_OP_256f32>;
    case NPY_DOUBLE:
      return SimpleMathOpFastSymmetric<double, __m256d, MulOp<double>,
                                       MUL_OP_256f64>;
    CASE_NPY_INT32:
      return SimpleMathOpFastSymmetric<int32_t, __m256i, MulOp<int32_t>,
                                       MUL_OP_256i32>;

    // CASE_NPY_INT64:   return SimpleMathOpFast<int64_t, __m256i,
    // MulOp<int64_t>, MUL_OP_256i64>;
    case NPY_INT16:
      return SimpleMathOpFastSymmetric<int16_t, __m256i, MulOp<int16_t>,
                                       MUL_OP_256i16>;
    ...
    CASE_NPY_UINT64:
      ...
      return SimpleMathOpFastSymmetric<uint64_t, __m256i, MulOp<uint64_t>,
                                       MUL_OP_256u64>;
    }
    return nullptr;
  ...
  case MATH_OPERATION::MIN:
    ...
    *wantedOutType = numpyInType1;
    ...
    CASE_NPY_INT32:
      return SimpleMathOpFastSymmetric<int32_t, __m256i, MinOp<int32_t>,
                                       MIN_OPi32>;
    case NPY_INT16:
      return SimpleMathOpFastSymmetric<int16_t, __m256i, MinOp<int16_t>,
                                       MIN_OPi16>;
    case NPY_INT8:
      return SimpleMathOpFastSymmetric<int8_t, __m256i, MinOp<int8_t>,
                                       MIN_OPi8>;
    CASE_NPY_UINT32:
      return SimpleMathOpFastSymmetric<uint32_t, __m256i, MinOp<uint32_t>,
                                       MIN_OPu32>;
    case NPY_UINT16:
      return SimpleMathOpFastSymmetric<uint16_t, __m256i, MinOp<uint16_t>,
                                       MIN_OPu16>;
    case NPY_UINT8:
      return SimpleMathOpFastSymmetric<uint8_t, __m256i, MinOp<uint8_t>,
                                       MIN_OPu8>;
    }
    return nullptr;
  ...
  case MATH_OPERATION::MAX:
    ...
    *wantedOutType = numpyInType1;
    ...
    CASE_NPY_INT32:
      return SimpleMathOpFastSymmetric<int32_t, __m256i, MaxOp<int32_t>,
                                       MAX_OPi32>;
    case NPY_INT16:
      return SimpleMathOpFastSymmetric<int16_t, __m256i, MaxOp<int16_t>,
                                       MAX_OPi16>;
    case NPY_INT8:
      return SimpleMathOpFastSymmetric<int8_t, __m256i, MaxOp<int8_t>,
                                       MAX_OPi8>;
    CASE_NPY_UINT32:
      return SimpleMathOpFastSymmetric<uint32_t, __m256i, MaxOp<uint32_t>,
                                       MAX_OPu32>;
    case NPY_UINT16:
      return SimpleMathOpFastSymmetric<uint16_t, __m256i, MaxOp<uint16_t>,
                                       MAX_OPu16>;
    case NPY_UINT8:
      return SimpleMathOpFastSymmetric<uint8_t, __m256i, MaxOp<uint8_t>,
                                       MAX_OPu8>;
    }
    return nullptr;
  ...
  case MATH_OPERATION::DIV:
    *wantedOutType = NPY_DOUBLE;
    ...
    switch (scalarMode == SCALAR_MODE::FIRST_ARG_SCALAR ? numpyInType2
                                                        : numpyInType1) {
    case NPY_FLOAT:
  ...
  case MATH_OPERATION::BITWISE_AND:
    *wantedOutType = numpyInType1;
    ...
    case NPY_UINT16:
    case NPY_INT16:
      return SimpleMathOpFastSymmetric<int16_t, __m256i, AndOp<int16_t>,
                                       AND_OP_256>;
    CASE_NPY_UINT32:
    CASE_NPY_INT32:
      return SimpleMathOpFastSymmetric<int32_t, __m256i, AndOp<int32_t>,
                                       AND_OP_256>;
    CASE_NPY_UINT64:

    CASE_NPY_INT64:

      return SimpleMathOpFastSymmetric<int64_t, __m256i, AndOp<int64_t>,
                                       AND_OP_256>;
    }
    return nullptr;
  ...
  case MATH_OPERATION::BITWISE_OR:
    *wantedOutType = numpyInType1;
    ...
    case NPY_UINT16:
    case NPY_INT16:
      return SimpleMathOpFastSymmetric<int16_t, __m256i, OrOp<int16_t>,
                                       OR_OP_256>;
    CASE_NPY_UINT32:
    CASE_NPY_INT32:
      return SimpleMathOpFastSymmetric<int32_t, __m256i, OrOp<int32_t>,
                                       OR_OP_256>;
    CASE_NPY_UINT64:

    CASE_NPY_INT64:

      return SimpleMathOpFastSymmetric<int64_t, __m256i, OrOp<int64_t>,
                                       OR_OP_256>;
    }
    return nullptr;
  ...
  case MATH_OPERATION::BITWISE_XOR:
    *wantedOutType = numpyInType1;
    ...
    case NPY_UINT8:
    case NPY_BOOL:
      return SimpleMathOpFastSymmetric<int8_t, __m256i, XorOp<int8_t>,
                                       XOR_OP_256>;
    case NPY_UINT16:
    case NPY_INT16:
      return SimpleMathOpFastSymmetric<int16_t, __m256i, XorOp<int16_t>,
                                       XOR_OP_256>;
    CASE_NPY_UINT32:
    CASE_NPY_INT32:
      return SimpleMathOpFastSymmetric<int32_t, __m256i, XorOp<int32_t>,
                                       XOR_OP_256>;
    CASE_NPY_UINT64:

    CASE_NPY_INT64:

      return SimpleMathOpFastSymmetric<int64_t, __m256i, XorOp<int64_t>,
                                       XOR_OP_256>;
    }
    return nullptr;
  ...
  case MATH_OPERATION::BITWISE_ANDNOT:
    *wantedOutType = numpyInType1;
    ...
    case NPY_UINT8:
    case NPY_BOOL:
      return SimpleMathOpFastReverse<int8_t, __m256i, AndNotOp<int8_t>,
                                     ANDNOT_OP_256>;
    case NPY_UINT16:
    case NPY_INT16:
      return SimpleMathOpFastReverse<int16_t, __m256i, AndNotOp<int16_t>,
                                     ANDNOT_OP_256>;
    CASE_NPY_UINT32:
    CASE_NPY_INT32:
      return SimpleMathOpFastReverse<int32_t, __m256i, AndNotOp<int32_t>,
                                     ANDNOT_OP_256>;
    CASE_NPY_UINT64:

    CASE_NPY_INT64:

      return SimpleMathOpFastReverse<int64_t, __m256i, AndNotOp<int64_t>,
                                     ANDNOT_OP_256>;
    }
    return nullptr;
  ...
  case MATH_OPERATION::BITWISE_NOTAND:
    *wantedOutType = numpyInType1;
    ...
    case NPY_UINT16:
    case NPY_INT16:
      return SimpleMathOpFast<int16_t, __m256i, AndNotOp<int16_t>,
                              ANDNOT_OP_256>;
    CASE_NPY_UINT32:
    CASE_NPY_INT32:
      return SimpleMathOpFast<int32_t, __m256i, AndNotOp<int32_t>,
                              ANDNOT_OP_256>;
    CASE_NPY_UINT64:

    CASE_NPY_INT64:

      return SimpleMathOpFast<int64_t, __m256i, AndNotOp<int64_t>,
                              ANDNOT_OP_256>;
    }
    return nullptr;
  }
...
static ANY_TWO_FUNC GetSimpleMathOpSlow(int func, int scalarMode,
                                        int numpyInType1, int numpyInType2,
                                        int numpyOutType, int *wantedOutType) {
  switch (func) {
  case MATH_OPERATION::ADD:
    *wantedOutType = numpyInType1;
    ...
    case NPY_STRING:
      if (numpyInType1 == numpyInType2 &&
          scalarMode == SCALAR_MODE::NO_SCALARS) {
      }
      break;
...
static ANY_TWO_FUNC CheckMathOpTwoInputs(int func, int scalarMode,
                                         int numpyInType1, int numpyInType2,
                                         int numpyOutType, int *wantedOutType) {
  ...
  if (numpyInType1 <= NPY_LONGDOUBLE && numpyInType2 <= NPY_LONGDOUBLE) {
    ...
    case MATH_OPERATION::SUBDATES:
      if (scalarMode == SCALAR_MODE::NO_SCALARS &&
        ...
        // rare)
        if (GetNonAmbiguousDtype(numpyInType1) !=
            GetNonAmbiguousDtype(numpyInType2)) {
      ...
      pTwoFunc = GetSimpleMathOpFast(func, scalarMode, numpyInType1,
                                     numpyInType2, numpyOutType, wantedOutType);
      if (pTwoFunc == nullptr) {
        pTwoFunc =
            GetSimpleMathOpSlow(func, scalarMode, numpyInType1, numpyInType2,
                                numpyOutType, wantedOutType);
      }
      break;
    ...
    case MATH_OPERATION::CMP_LTE:
      pTwoFunc = GetComparisonOpFast(func, scalarMode, numpyInType1,
                                     numpyInType2, numpyOutType, wantedOutType);
      if (pTwoFunc == nullptr) {
        pTwoFunc =
            GetComparisonOpSlow(func, scalarMode, numpyInType1, numpyInType2,
                                numpyOutType, wantedOutType);
      }
      break;
...
static int g_signed_table[65] = {
    NPY_INT8,  NPY_INT8,  NPY_INT8,  NPY_INT8,  NPY_INT8,  NPY_INT8,  NPY_INT8,
    NPY_INT8,  NPY_INT16, NPY_INT16, NPY_INT16, NPY_INT16, NPY_INT16, NPY_INT16,
    NPY_INT16, NPY_INT16, NPY_INT32, NPY_INT32, NPY_INT32, NPY_INT32, NPY_INT32,
    NPY_INT32, NPY_INT32, NPY_INT32, NPY_INT32, NPY_INT32, NPY_INT32, NPY_INT32,
    NPY_INT32, NPY_INT32, NPY_INT32, NPY_INT32, NPY_INT64, NPY_INT64, NPY_INT64,
    NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64,
    NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64,
    NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64,
    NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64, NPY_INT64,
    NPY_INT64, NPY_INT64};
...
static int g_mixedsign_table[65] = {
    ...
    NPY_INT8,  NPY_INT8,  NPY_UINT8,  NPY_INT16, NPY_INT16,  NPY_INT16,
    NPY_INT16, NPY_INT16, NPY_INT16,  NPY_INT16, NPY_UINT16, NPY_INT32,
    NPY_INT32, NPY_INT32, NPY_INT32,  NPY_INT32, NPY_INT32,  NPY_INT32,
    NPY_INT32, NPY_INT32, NPY_INT32,  NPY_INT32, NPY_INT32,  NPY_INT32,
    NPY_INT32, NPY_INT32, NPY_UINT32, NPY_INT64, NPY_INT64,  NPY_INT64,
    NPY_INT64, NPY_INT64, NPY_INT64,  NPY_INT64, NPY_INT64,  NPY_INT64,
    NPY_INT64, NPY_INT64, NPY_INT64,  NPY_INT64, NPY_INT64,  NPY_INT64,
    NPY_INT64, NPY_INT64, NPY_INT64,  NPY_INT64, NPY_INT64,  NPY_INT64,
    NPY_INT64, NPY_INT64, NPY_INT64,  NPY_INT64, NPY_INT64,  NPY_INT64,
    NPY_INT64, NPY_INT64, NPY_INT64,  NPY_INT64, NPY_UINT64};
static int g_bothunsigned_table[65] = {
    NPY_UINT8,  NPY_UINT8,  NPY_UINT8,  NPY_UINT8,  NPY_UINT8,  NPY_UINT8,
    NPY_UINT8,  NPY_UINT8,  NPY_UINT8,  NPY_UINT16, NPY_UINT16, NPY_UINT16,
    NPY_UINT16, NPY_UINT16, NPY_UINT16, NPY_UINT16, NPY_UINT16, NPY_UINT32,
    NPY_UINT32, NPY_UINT32, NPY_UINT32, NPY_UINT32, NPY_UINT32, NPY_UINT32,
    NPY_UINT32, NPY_UINT32, NPY_UINT32, NPY_UINT32, NPY_UINT32, NPY_UINT32,
    NPY_UINT32, NPY_UINT32, NPY_UINT32, NPY_UINT64, NPY_UINT64, NPY_UINT64,
    NPY_UINT64, NPY_UINT64, NPY_UINT64, NPY_UINT64, NPY_UINT64, NPY_UINT64,
    NPY_UINT64, NPY_UINT64, NPY_UINT64, NPY_UINT64, NPY_UINT64, NPY_UINT64,
    NPY_UINT64, NPY_UINT64, NPY_UINT64, NPY_UINT64, NPY_UINT64, NPY_UINT64,
    NPY_UINT64, NPY_UINT64, NPY_UINT64, NPY_UINT64, NPY_UINT64, NPY_UINT64,
...
public:
  ...
  int PossiblyUpcast(PyObject *scalarObject, int dtype) {
    if (PyLong_Check(scalarObject)) {
      ...
      if (dtype <= NPY_ULONGLONG) {
        ...
        if (!overflow) {
          ...
          bool result = GetUpcastType(dtype, scalar_dtype, convertType1,
                                      convertType2, funcNumber);
          LOGGING("Getting upcast %d %d, result %d  convert:%d\n", dtype,
                  scalar_dtype, result, convertType1);
          if (result) {
            return convertType1;
          }
        } else {
    ...
    // Check if they passed a numpy scalar
      ...
      if (scalarType != dtype && scalarType <= NPY_LONGDOUBLE) {
        ...
        bool result = GetUpcastType(dtype, scalarType, convertType1,
                                    convertType2, funcNumber);
        if (result) {
          return convertType1;
        }
  ...
  PyObject *PossiblyConvertString(int newType, int oldType,
                                  PyObject *inObject) {
  ...
  bool CheckInputs(PyObject *args, int defaultScalarType, int64_t funcNumber) {
    ...
    if (tupleSize != (expectedTupleSize - 1) &&
        tupleSize != expectedTupleSize) {
      PyErr_Format(
          PyExc_ValueError,
          "BasicMath only takes two or three arguments instead of %llu args",
          tupleSize);
      return false;
    }
  ...
  bool CheckUpcast() {
    ...
    if (numpyInType1 != numpyInType2) {
      ...
      if (numpyInType1 != numpyInType2) {
        ...
        bool result = GetUpcastType(numpyInType1, numpyInType2, convertType1,
                                    convertType2, funcNumber);
        if (result) {
  ...
  bool CheckInputsInternal(int defaultScalarType, int64_t funcNumber) {
    ...
    if (!isArray1) {
      ...
      if (!isScalar1) {
        ...
        toDelete1 = inObject1 = PyArray_FromAny(inObject1, nullptr, 0, 0,
                                                NPY_ARRAY_ENSUREARRAY, nullptr);
        ...
        if (newType != oldType) {
          if (newType <= NPY_LONGDOUBLE) {
            ...
            PyObject *newarray2 =
                ConvertSafeInternal((PyArrayObject *)inObject2, newType);
            if (!newarray2) {
              // Failed to convert
              return false;
            }
    ...
    if (!isArray2) {
      ...
      if (!isScalar2) {
        ...
        toDelete2 = inObject2 = PyArray_FromAny(inObject2, nullptr, 0, 0,
                                                NPY_ARRAY_ENSUREARRAY, nullptr);
        ...
        if (newType != oldType) {
          if (newType <= NPY_LONGDOUBLE) {
            ...
            LOGGING("Converting because of scalar2 to %d from %d\n", newType,
                    oldType);
            PyObject *newarray1 =
                ConvertSafeInternal((PyArrayObject *)inObject1, newType);
            if (!newarray1) {
              // Failed to convert
              return false;
            }
    ...
    if (isScalar1) {
      ...
      bool bResult = ConvertScalarObject(inObject1, &m256Scalar1, numpyInType2,
                                         &pDataIn1, &itemSize1);

      LOGGING("Converting first scalar type to %d, bresult: %d,  value: %lld  "
              "inObject1: %s\n",
              numpyInType2, bResult, *(int64_t *)&m256Scalar1,
              inObject1->ob_type->tp_name);
    ...
    if (isScalar2) {
      ...
      bool bResult = ConvertScalarObject(inObject2, &m256Scalar2, numpyInType1,
                                         &pDataIn2, &itemSize2);

      LOGGING("Converting second scalar type to %d, bresult: %d,  value: %lld  "
              "type: %s\n",
              numpyInType1, bResult, *(int64_t *)&m256Scalar2,
              inObject2->ob_type->tp_name);
      ...
      // Check strides
      if (ndim2 > 0 &&
          itemSize2 != PyArray_STRIDE((PyArrayObject *)inArr2, 0)) {
        return false;
      }
    ...
    if (scalarMode == SCALAR_MODE::NO_SCALARS) {
      ...
      if (len1 != len2) {
        ...
        if (len1 == 1 && len2 >= 1) {
          ...
          if (result) {
            LOGGING(
                "setting BM to first arg scalar from %d to %d.  ndim1: %d\n",
                numpyInType1, convertType1, ndim1);
            // Convert
            bool bResult = ConvertSingleItemArray(pDataIn1, numpyInType1,
                                                  &m256Scalar1, convertType1);
            ...
            if (numpyInType2 != convertType2 &&
                convertType2 <= NPY_LONGDOUBLE) {
              // Convert
              LOGGING("converting array2 to %d  from  %d and %d\n",
          ...
          if (result) {
            LOGGING(
                "setting BM to second arg scalar from %d to %d.  ndim2: %d\n",
                numpyInType2, convertType2, ndim2);

            // Convert
            bool bResult = ConvertSingleItemArray(pDataIn2, numpyInType2,
                                                  &m256Scalar2, convertType2);
            ...
            if (numpyInType1 != convertType1 &&
                convertType1 <= NPY_LONGDOUBLE) {
              // Convert
              LOGGING("converting array1 to %d  from  %d and %d\n",
          ...
          LOGGING("BasicMath needs matching 1 dim x 1 dim array   %llu x %llu. "
                  " Will punt to numpy.\n",
                  len1, len2);
  ...
  PyArrayObject *CheckOutputs(int wantOutType) {
    ...
    if (outputObject) {
      ...
      if (!PyArray_Check(outputObject)) {
        ...
        PyErr_Format(PyExc_ValueError,
                     "BasicMath needs third argument to be an array");
        return nullptr;
      }
      ...
      if (PyArray_TYPE((PyArrayObject *)outputObject) != wantOutType) {
        ...
        if (PyArray_ITEMSIZE((PyArrayObject *)outputObject) !=
            PyArray_STRIDE((PyArrayObject *)outputObject, 0)) {
    ...
    if (outputObject) {
      ...
      char *pOutputEnd =
          pOutput + ArrayLength(returnObject) * PyArray_ITEMSIZE(returnObject);
      bool bOverlapProblem = false;

      if (len1) {
        if (pDataIn1 > pOutput && pDataIn1 < pOutputEnd) {
          printf("!!!warning: inplace operation has memory overlap in "
        ...
        if (pTempEnd > pOutput && pTempEnd < pOutputEnd) {
          printf("!!!warning: inplace operation has memory overlap at end for "
                 "input1\n");
          bOverlapProblem = true;
        }
      }
      ...
      if (len1 <= 0 && len2 <= 0) {
        ...
        if (ndim1 > 1) {
          returnObject =
              AllocateNumpyArray(ndim1, dims1, wantOutType, 0,
                                 (flags1 & flags2 & NPY_ARRAY_F_CONTIGUOUS) ==
        ...
        if (ndim2 > 1) {
          returnObject =
              AllocateNumpyArray(ndim2, dims2, wantOutType, 0,
                                 (flags1 & flags2 & NPY_ARRAY_F_CONTIGUOUS) ==
                                     NPY_ARRAY_F_CONTIGUOUS);
        } else {
    ...
    if (returnObject == nullptr) {
      ...
      PyErr_Format(PyExc_ValueError,
                   "BasicMath has no output (possibly out of memory)");
      return nullptr;
    }
...
static bool BasicMathThreadCallback(struct stMATH_WORKER_ITEM *pstWorkerItem,
  ...
  while ((lenX = pstWorkerItem->GetNextWorkBlock(&workBlock)) > 0) {
    ...
    case NO_SCALARS:
      ...
      OldCallback->FunctionList->AnyTwoStubCall(
          pDataInX + offsetAdj, pDataInX2 + offsetAdj, pDataOutX + outputAdj,
          lenX, OldCallback->ScalarMode);
      break;

    case FIRST_ARG_SCALAR:
      // Process this block of work
      OldCallback->FunctionList->AnyTwoStubCall(pDataInX, pDataInX2 + offsetAdj,
                                                pDataOutX + outputAdj, lenX,
                                                OldCallback->ScalarMode);
      break;

    case SECOND_ARG_SCALAR:
      // Process this block of work
      OldCallback->FunctionList->AnyTwoStubCall(pDataInX + offsetAdj, pDataInX2,
                                                pDataOutX + outputAdj, lenX,
                                                OldCallback->ScalarMode);
      break;
...
//------------------------------------------------------------------------------
//
void WorkTwoStubCall(FUNCTION_LIST *anyTwoStubCall, void *pDataIn,
                     void *pDataIn2, void *pDataOut, int64_t len,
                     int32_t scalarMode) {
  ...
  if (pWorkItem == nullptr) {
    ...
    // thread
    anyTwoStubCall->AnyTwoStubCall(pDataIn, pDataIn2, pDataOut, len,
                                   scalarMode);
    return;
  }
...
//
PyObject *ConcatTwoStrings(int32_t scalarMode, char *pStr1, char *pStr2,
                           int64_t itemSize1, int64_t itemSize2,
                           int64_t length) {
  ...
  PyArrayObject *pNewString =
      AllocateNumpyArray(1, (npy_intp *)&length, NPY_STRING, itemSizeOut);
...
//
PyObject *ConcatTwoUnicodes(int32_t scalarMode, uint32_t *pStr1,
                            uint32_t *pStr2, int64_t itemSize1,
                            int64_t itemSize2, int64_t length) {
  ...
  PyArrayObject *pNewString =
      AllocateNumpyArray(1, (npy_intp *)&length, NPY_UNICODE, itemSizeOut * 4);
  CHECK_MEMORY_ERROR(pNewString);
...
static PyObject *PossiblyAddUnicode(CTwoInputs &twoInputs) {
  ...
  if (twoInputs.scalarMode == SCALAR_MODE::FIRST_ARG_SCALAR &&
      (twoInputs.numpyInType2 == NPY_STRING ||
       twoInputs.numpyInType2 == NPY_UNICODE)) {
    inType = twoInputs.numpyInType2;
    LOGGING("First arg scalar %d %lld %lld\n", inType, twoInputs.itemSize1,
            twoInputs.itemSize2);
  }
  if (twoInputs.scalarMode == SCALAR_MODE::SECOND_ARG_SCALAR &&
      (twoInputs.numpyInType1 == NPY_STRING ||
       twoInputs.numpyInType1 == NPY_UNICODE)) {
    inType = twoInputs.numpyInType1;
    LOGGING("Second arg scalar %d %lld %lld\n", inType, twoInputs.itemSize1,
            twoInputs.itemSize2);
  }

  if (twoInputs.scalarMode == SCALAR_MODE::NO_SCALARS &&
  ...
  if (inType != -1) {
    if (inType == NPY_STRING) {
      ...
      return ConcatTwoStrings(
          twoInputs.scalarMode, (char *)twoInputs.pDataIn1,
          (char *)twoInputs.pDataIn2, twoInputs.itemSize1, twoInputs.itemSize2,
          twoInputs.len1 >= twoInputs.len2 ? twoInputs.len1 : twoInputs.len2);
    }
    if (inType == NPY_UNICODE) {
      // printf("before call\n");
      return ConcatTwoUnicodes(
          twoInputs.scalarMode, (uint32_t *)twoInputs.pDataIn1,
          (uint32_t *)twoInputs.pDataIn2, twoInputs.itemSize1,
          twoInputs.itemSize2,
          twoInputs.len1 >= twoInputs.len2 ? twoInputs.len1 : twoInputs.len2);
    }
  }
...
PyObject *TwoInputsInternal(CTwoInputs &twoInputs, int64_t funcNumber) {
  ...
  pTwoFunc = CheckMathOpTwoInputs(
      (int)funcNumber, twoInputs.scalarMode, twoInputs.numpyInType1,
      twoInputs.numpyInType2, twoInputs.numpyOutType, &wantedOutputType);
  ...
  LOGGING(" inner %p %p %d  lens: %lld %lld\n", outputArray, pTwoFunc,
          wantedOutputType, twoInputs.len1, twoInputs.len2);
  ...
  if (outputArray && pTwoFunc && wantedOutputType != -1) {
    ...
    if (twoInputs.len1 > 0 || twoInputs.len2 > 0) {
      ...
      fl.InputItemSize = twoInputs.len1 >= twoInputs.len2
                             ? PyArray_ITEMSIZE(twoInputs.inArr)
                             : PyArray_ITEMSIZE(twoInputs.inArr2);
      fl.OutputItemSize = PyArray_ITEMSIZE(outputArray);

      fl.NumpyOutputType = wantedOutputType;
      fl.NumpyType = twoInputs.len1 >= twoInputs.len2 ? twoInputs.numpyInType1
                                                      : twoInputs.numpyInType2;
      fl.TypeOfFunctionCall = TYPE_OF_FUNCTION_CALL::ANY_TWO;

      LOGGING("Calling func %p %p %p %llu %llu %d\n", twoInputs.pDataIn1,
              twoInputs.pDataIn2, pDataOut, twoInputs.len1, twoInputs.len2,
      ...
      WorkTwoStubCall(&fl, twoInputs.pDataIn1, twoInputs.pDataIn2, pDataOut,
                      twoInputs.len1 >= twoInputs.len2 ? twoInputs.len1
                                                       : twoInputs.len2,
                      twoInputs.scalarMode);
...
PyObject *BasicMathTwoInputs(PyObject *self, PyObject *args) {
  ...
  if (Py_SIZE(args) != 3) {
    PyErr_Format(PyExc_ValueError,
                 "BasicMathTwoInputs requires three inputs: tuple, long, long");
    return nullptr;
  }
  ...
  if (!PyTuple_CheckExact(tuple)) {
    PyErr_Format(PyExc_ValueError,
                 "BasicMathTwoInputs arguments needs to be a tuple");
    return nullptr;
  }
...
PyObject *BasicMathTwoInputsFromNumber(PyObject *input1, PyObject *input2,
                                       PyObject *output, int64_t funcNumber) {
...
template <typename T>
bool WhereCallback(void *callbackArgT, int core, int64_t start,
                   int64_t length) {
  ...
  if (pCallback->scalarMode == SCALAR_MODE::NO_SCALARS ||
      pCallback->scalarMode == SCALAR_MODE::SECOND_ARG_SCALAR) {
    pInput1 = &pInput1[start * strides1];
  }
  if (pCallback->scalarMode == SCALAR_MODE::NO_SCALARS ||
      pCallback->scalarMode == SCALAR_MODE::FIRST_ARG_SCALAR) {
    pInput2 = &pInput2[start * strides2];
  }

  LOGGING("[%d] Where start: %lld  length: %lld   scalar: %d  strides1: %lld  "
          "strides2: %lld\n",
...
bool WhereCallbackString(void *callbackArgT, int core, int64_t start,
                         int64_t length) {
...
PyObject *Where(PyObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "O!OLL", &PyArray_Type, &inBool1, &tuple,
                        &numpyOutputType, &numpyItemSize)) {
  ...
  if (!PyTuple_CheckExact(tuple)) {
    PyErr_Format(PyExc_ValueError,
                 "Where: second argument needs to be a tuple");
    return nullptr;
  }

  if (PyArray_TYPE(inBool1) != 0) {
    PyErr_Format(PyExc_ValueError,
                 "Where: first argument must be a boolean array");
    return nullptr;
  }
  ...
  if (result) {
    ...
    LOGGING("Where input: scalarmode: %d  in1:%d in2:%d  out:%d  length: %lld  "
            "itemsize: %lld\n",
            twoInputs.scalarMode, twoInputs.numpyInType1,
            twoInputs.numpyInType2, twoInputs.numpyOutType, length,
            numpyItemSize);

    // Place holder for output array
    PyArrayObject *outputArray = nullptr;

    outputArray = AllocateNumpyArray(1, (npy_intp *)&length,
                                     (int)numpyOutputType, numpyItemSize);
    ...
    if (outputArray) {
      ...
      if (numpyOutputType == NPY_STRING || numpyOutputType == NPY_UNICODE) {
        if (twoInputs.scalarMode == SCALAR_MODE::BOTH_SCALAR ||
            twoInputs.scalarMode == SCALAR_MODE::FIRST_ARG_SCALAR) {
        ...
        if (twoInputs.scalarMode == SCALAR_MODE::BOTH_SCALAR ||
            twoInputs.scalarMode == SCALAR_MODE::SECOND_ARG_SCALAR) {
      ...
      if (twoInputs.scalarMode == SCALAR_MODE::NO_SCALARS ||
        ...
        if (twoInputs.ndim1 == 1)
          WCBS.strideSize1 =
              PyArray_STRIDE(twoInputs.inArr, 0) / twoInputs.itemSize1;
      }
      if (twoInputs.scalarMode == SCALAR_MODE::NO_SCALARS ||
          twoInputs.scalarMode == SCALAR_MODE::FIRST_ARG_SCALAR) {
        if (twoInputs.ndim2 == 1)
          WCBS.strideSize2 =
              PyArray_STRIDE(twoInputs.inArr2, 0) / twoInputs.itemSize2;
      }

      switch (numpyItemSize) {
      case 1:
        g_cMathWorker->DoMultiThreadedChunkWork(length, WhereCallback<int8_t>,
                                                &WCBS);
        break;
      case 2:
        g_cMathWorker->DoMultiThreadedChunkWork(length, WhereCallback<int16_t>,
                                                &WCBS);
        break;
      case 4:
        g_cMathWorker->DoMultiThreadedChunkWork(length, WhereCallback<int32_t>,
                                                &WCBS);
        break;
      case 8:
        g_cMathWorker->DoMultiThreadedChunkWork(length, WhereCallback<int64_t>,
                                                &WCBS);
        break;
      default:
        g_cMathWorker->DoMultiThreadedChunkWork(length, WhereCallbackString,
                                                &WCBS);
        break;
      }
