...
extern PyObject *MultiKeyGroupBy32(PyObject *self, PyObject *args,
                                   PyObject *kwargs);
...
extern ArrayInfo *BuildArrayInfo(PyObject *listObject, int64_t *pTupleSize,
                                 int64_t *pTotalItemSize, bool checkrows = true,
                                 bool convert = true);
