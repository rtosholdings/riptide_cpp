...
// Define a way to make a baby math function which calls into larger math function with an op index
// the index is used to lookup in the MathHook table to call the proper function
#define DEF_HOOKB(_NAME_, _OP_) PyObject *Riptide##_NAME_(PyObject *self, PyObject *right) {return RiptideBinaryMathFunction(self,right,_OP_);}
#define DEF_HOOKI(_NAME_, _OP_) PyObject *Riptide##_NAME_(PyObject *self, PyObject *right) {return RiptideBinaryMathFunctionInplace(self,right,_OP_);}
#define DEF_HOOKU(_NAME_, _OP_) PyObject *Riptide##_NAME_(PyObject *self) {return RiptideUnaryMathFunction(self,_OP_);}
#define DEF_HOOKT(_NAME_, _OP_) PyObject *Riptide##_NAME_(PyObject *self, PyObject *arg1, PyObject* arg2) {return RiptideTernaryMathFunction(self,arg1,arg2,_OP_);}
#define DEF_HOOKS(_NAME_, _OP_) PyObject *Riptide##_NAME_(PyObject *self, PyObject *arg1, PyObject* arg2) {return RiptideTernaryMathFunctionInplace(self,arg1,arg2,_OP_);}

// Make a baby function for each routine that calls into the larger math function
// This order must match the order in g_MathHook
DEF_HOOKB(ADD, 0); 
DEF_HOOKB(SUB, 1);
DEF_HOOKB(MUL, 2);
DEF_HOOKB(DIV, 3);
...
// This table is used to go from PyNumberMethods to our hook while recording the current function
// It is like a vtable
...
// Comparison functions: '__lt__', '__le__', '__eq__', '__ne__', '__gt__', '__ge__',
// Other: '__iter__', '__add__', '__radd__', '__sub__', '__rsub__', '__mul__', '__rmul__',
//'__mod__', '__rmod__', '__divmod__', '__rdivmod__', '__pow__', '__rpow__', '__neg__', '__pos__',
//'__abs__', '__bool__', '__invert__', '__lshift__', '__rlshift__', '__rshift__', '__rrshift__',
//'__and__', '__rand__', '__xor__', '__rxor__', '__or__', '__ror__', '__iand__', '__ixor__', '__ior__', 
//'__int__', '__float__', '__iadd__', '__isub__', '__imul__', '__imod__', '__ipow__', '__ilshift__', '__irshift__',
//'__floordiv__', '__rfloordiv__', '__truediv__', '__rtruediv__', '__ifloordiv__', '__itruediv__',
...
static const MATH_OPERATION COMP_TABLE[6] = {
   MATH_OPERATION::CMP_LT,
   MATH_OPERATION::CMP_LTE,
   MATH_OPERATION::CMP_EQ,
   MATH_OPERATION::CMP_NE,
   MATH_OPERATION::CMP_GT,
...
static
PyObject* CompareFunction(PyObject* left, PyObject* right, int opcode) {
   // TODO: Change this to something like opcode < sizeof(COMP_TABLE) -- that'll compile to the same code but still works if COMP_TABLE is ever changed.
   if (opcode < 6) {
...
BasicMathHook(PyObject *self, PyObject *args) {
   ...
   if (!PyArg_ParseTuple(
      args, "OO", &fastArrayClass, &npArrayClass)) {
