...
static PyObject *RiptideTernaryMathFunction(PyObject *self, PyObject *arg1,
                                            PyObject *arg2, int64_t index) {
  ...
  if (arg2 == Py_None) {
    ...
    if (PyLong_Check(arg1)) {
      ...
      if (power == 2 || power == 3 || power == 4) {
        PyObject *square =
            BasicMathTwoInputsFromNumber(self, self, NULL, MATH_OPERATION::MUL);
        if (square != Py_None) {
          if (power == 3) {
            // inplace multiply
            BasicMathTwoInputsFromNumber(square, self, square,
                                         MATH_OPERATION::MUL);
            Py_DECREF(square);
          } else if (power == 4) {
            // inplace multiply
            BasicMathTwoInputsFromNumber(square, square, square,
                                         MATH_OPERATION::MUL);
            Py_DECREF(square);
          }
          return square;
    ...
    PyObject *result = BasicMathTwoInputsFromNumber(self, arg1, NULL,
                                                    g_MathHook[index].MathOp);
    if (result != Py_None) {
      return result;
    }
  }
...
static PyObject *RiptideTernaryMathFunctionInplace(PyObject *self,
                                                   PyObject *arg1,
                                                   PyObject *arg2,
                                                   int64_t index) {
  ...
  PyObject *result =
      BasicMathTwoInputsFromNumber(self, arg1, self, g_MathHook[index].MathOp);
  if (arg2 == Py_None) {
    if (result != Py_None) {
      return result;
    }
...
static PyObject *RiptideUnaryMathFunction(PyObject *self, int64_t index) {
  ...
  PyObject *result = BasicMathOneInputFromNumber(
      (PyArrayObject *)self, g_MathHook[index].MathOp, false);
  if (result != Py_None) {
    return result;
  }
  // punt to numpy
...
static PyObject *RiptideBinaryMathFunction(PyObject *self, PyObject *right,
                                           int64_t index) {
  //
  ...
  PyObject *result =
      BasicMathTwoInputsFromNumber(self, right, NULL, g_MathHook[index].MathOp);
  if (result != Py_None) {
    return result;
  }
  // punt to numpy
...
static PyObject *RiptideBinaryMathFunctionInplace(PyObject *self,
                                                  PyObject *right,
                                                  int64_t index) {
  //
  ...
  PyObject *result =
      BasicMathTwoInputsFromNumber(self, right, self, g_MathHook[index].MathOp);
  if (result != Py_None) {
    ...
    if (self_dtype != out_dtype) {
      PyObject *newarray1 =
          ConvertSafeInternal((PyArrayObject *)result, self_dtype);
      if (newarray1) {
...
stMATH_HOOK g_MathHook[] = {
    {MATH_OPERATION::ADD, (void *)RiptideADD, NULL,
     offsetof(PyNumberMethods, nb_add)}, // x + y
    {MATH_OPERATION::SUB, (void *)RiptideSUB, NULL,
     offsetof(PyNumberMethods, nb_subtract)}, // x - y
    {MATH_OPERATION::MUL, (void *)RiptideMUL, NULL,
     offsetof(PyNumberMethods, nb_multiply)}, // x * y
    {MATH_OPERATION::DIV, (void *)RiptideDIV, NULL,
     offsetof(PyNumberMethods, nb_true_divide)}, // x / y
    {MATH_OPERATION::FLOORDIV, (void *)RiptideFDIV, NULL,
     offsetof(PyNumberMethods, nb_floor_divide)}, // x // y

    {MATH_OPERATION::ADD, (void *)RiptideIADD, NULL,
     offsetof(PyNumberMethods, nb_inplace_add)}, // x += y
    {MATH_OPERATION::SUB, (void *)RiptideISUB, NULL,
     offsetof(PyNumberMethods, nb_inplace_subtract)}, // x -= y
    {MATH_OPERATION::MUL, (void *)RiptideIMUL, NULL,
     offsetof(PyNumberMethods, nb_inplace_multiply)}, // x *= y
    {MATH_OPERATION::DIV, (void *)RiptideIDIV, NULL,
     offsetof(PyNumberMethods, nb_inplace_true_divide)}, // x /= y
    {MATH_OPERATION::FLOORDIV, (void *)RiptideIFDIV, NULL,
     offsetof(PyNumberMethods, nb_inplace_floor_divide)}, // x //= y

    {MATH_OPERATION::BITWISE_AND, (void *)RiptideBWAND, NULL,
     offsetof(PyNumberMethods, nb_and)}, // x & y
    {MATH_OPERATION::BITWISE_OR, (void *)RiptideBWOR, NULL,
     offsetof(PyNumberMethods, nb_or)}, // x | y
    {MATH_OPERATION::BITWISE_XOR, (void *)RiptideBWXOR, NULL,
     offsetof(PyNumberMethods, nb_xor)}, // x ^ y
    {MATH_OPERATION::BITWISE_AND, (void *)RiptideIBWAND, NULL,
     offsetof(PyNumberMethods, nb_inplace_and)}, // x &= y
    {MATH_OPERATION::BITWISE_OR, (void *)RiptideIBWOR, NULL,
     offsetof(PyNumberMethods, nb_inplace_or)}, // x |= y
    {MATH_OPERATION::BITWISE_XOR, (void *)RiptideIBWXOR, NULL,
     offsetof(PyNumberMethods, nb_inplace_xor)}, // x ^= y

    // TODO: implement
    {MATH_OPERATION::BITWISE_LSHIFT, (void *)RiptideLSHIFT, NULL,
     offsetof(PyNumberMethods, nb_lshift)}, // x << y
    {MATH_OPERATION::BITWISE_RSHIFT, (void *)RiptideRSHIFT, NULL,
     offsetof(PyNumberMethods, nb_rshift)}, // x >> y
    {MATH_OPERATION::BITWISE_LSHIFT, (void *)RiptideILSHIFT, NULL,
     offsetof(PyNumberMethods, nb_inplace_lshift)}, // x <<= y
    {MATH_OPERATION::BITWISE_RSHIFT, (void *)RiptideIRSHIFT, NULL,
     offsetof(PyNumberMethods, nb_inplace_rshift)}, // x >>= y

    {MATH_OPERATION::MOD, (void *)RiptideMOD, NULL,
     offsetof(PyNumberMethods, nb_remainder)}, // x % y
    {MATH_OPERATION::ABS, (void *)RiptideABS, NULL,
     offsetof(PyNumberMethods, nb_absolute)}, // abs(x)
    {MATH_OPERATION::NEG, (void *)RiptideNEG, NULL,
     offsetof(PyNumberMethods, nb_negative)}, // -x
    {MATH_OPERATION::INVERT, (void *)RiptideINVERT, NULL,
     offsetof(PyNumberMethods, nb_invert)}, // ~x

    {MATH_OPERATION::POWER, (void *)RiptidePOWER, NULL,
     offsetof(PyNumberMethods, nb_power)}, // x**y  or pow(x,y,modulus)
    {MATH_OPERATION::POWER, (void *)RiptideIPOWER, NULL,
     offsetof(PyNumberMethods, nb_inplace_power)}, // x**=y
...
static const MATH_OPERATION COMP_TABLE[6] = {
    MATH_OPERATION::CMP_LT, MATH_OPERATION::CMP_LTE, MATH_OPERATION::CMP_EQ,
...
static PyObject *CompareFunction(PyObject *left, PyObject *right, int opcode) {
  ...
  if (opcode < 6) {
    PyObject *result =
        BasicMathTwoInputsFromNumber(left, right, NULL, COMP_TABLE[opcode]);
    if (result != Py_None) {
      return result;
    }
  }
  ...
  if (g_ishooked == 0) {
    ...
    if (numbermethods) {
      ...
      while (true) {
        ...
        NUMBER_FUNC *numberfunc =
            (NUMBER_FUNC *)((const char *)numbermethods + g_MathHook[i].Offset);
        ...
        *numberfunc = g_MathHook[i].Method;
        ...
        if (hookNumpy) {
          numberfunc = (NUMBER_FUNC *)((const char *)numbermethods_np +
                                       g_MathHook[i].Offset);
          *numberfunc = g_MathHook[i].Method;
        }
        i++;
