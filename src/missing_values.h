 ...
 * given C++ type.
 */
template <typename T> struct invalid_for_type {};

template <> struct invalid_for_type<bool> {
...
template <> struct invalid_for_type<int8_t> {
   ...
   * @return false The value is invalid / NaN.
   */
  static constexpr bool is_valid(const int8_t x) { return x != value; }
};

template <> struct invalid_for_type<int16_t> {
   ...
   * @return false The value is invalid / NaN.
   */
  static constexpr bool is_valid(const int16_t x) { return x != value; }
};

template <> struct invalid_for_type<int32_t> {
   ...
   * @return false The value is invalid / NaN.
   */
  static constexpr bool is_valid(const int32_t x) { return x != value; }
};

template <> struct invalid_for_type<int64_t> {
   ...
   * @return false The value is invalid / NaN.
   */
  static constexpr bool is_valid(const int64_t x) { return x != value; }
};

template <> struct invalid_for_type<uint8_t> {
  // NOTE: We don't use std::numeric_limits<int8_t>::min() here, because if the
  // value
  //       differs between platforms (for whatever reason), it'd mean that
  //       different systems would interpret the same data values differently.
   ...
   * @return false The value is invalid / NaN.
   */
  static constexpr bool is_valid(const uint8_t x) { return x != value; }
};

template <> struct invalid_for_type<uint16_t> {
   ...
   * @return false The value is invalid / NaN.
   */
  static constexpr bool is_valid(const uint16_t x) { return x != value; }
};

template <> struct invalid_for_type<uint32_t> {
   ...
   * @return false The value is invalid / NaN.
   */
  static constexpr bool is_valid(const uint32_t x) { return x != value; }
};

template <> struct invalid_for_type<uint64_t> {
   ...
   * @return false The value is invalid / NaN.
   */
  static constexpr bool is_valid(const uint64_t x) { return x != value; }
};

template <> struct invalid_for_type<float> {
...
template <> struct invalid_for_type<double> {
...
template <> struct invalid_for_type<long double> {
