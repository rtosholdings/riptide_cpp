...
public:
    ...
    static GROUPBY_X_FUNC32 GetXFunc2(GB_FUNCTIONS func)
    {
        ...
        case GB_ROLLING_DIFF: return AccumRollingDiff;
        case GB_ROLLING_SHIFT: return AccumRollingShift;
        case GB_ROLLING_COUNT: return AccumRollingCount;
        case GB_ROLLING_MEAN: return AccumRollingMean;
        case GB_ROLLING_NANMEAN: return AccumRollingNanMean;
        default: break;
        }
        return NULL;
    }
    ...
    static GROUPBY_X_FUNC32 GetXFunc(GB_FUNCTIONS func)
    {
        ...
        case GB_LAST: return AccumLast;
        case GB_MEDIAN: return AccumMedian;
        case GB_MODE: return AccumMode;
        default: break;
        }
        return NULL;
    }
    ...
    {
        // void AccumBinFirst(int32_t* pGroup, int32_t* pFirst, int32_t* pCount, char* pAccumBin, char* pColumn, int64_t numUnique,
        ...
        case GB_FIRST: return AccumFirstString;
        case GB_LAST: return AccumLastString;
        case GB_NTH: return AccumNthString;
        case GB_MEDIAN: return AccumMedianString;
        default: break;
        }
        return NULL;
    }
...
static GROUPBY_X_FUNC32 GetGroupByXFunction32(int inputType, int outputType, GB_FUNCTIONS func)
{
    ...
    else
    {
        ...
        case NPY_STRING: return GroupByBase<char, char, V>::GetXFuncString(func);
        case NPY_UNICODE:
        case NPY_VOID: return GroupByBase<char, char, V>::GetXFuncString(func);
        }
    }
    return NULL;
}
...
PyObject * GroupByAllPack32(PyObject * self, PyObject * args)
{
    ...
    CASE_NPY_INT64:
        ...
        break;
    default: PyErr_Format(PyExc_ValueError, "GroupByAllPack32 key param must int8, int16, int32, int64"); return NULL;
    }
    ...
    if ( returnTuple == NULL )
    {
                ...
                else
                {
                    ...
                    if ( funcNum >= GB_ROLLING_SUM )
                    {
                        ...
                        if ( aInfo[i].ArrayLength != pstGroupBy32->totalInputRows )
                        {
                            PyErr_Format(
                                PyExc_ValueError,
                                "GroupByAll32 for rolling functions, input size must be same size as group size: %lld vs %lld",
        ...
        //   if (pFunction) {
        //      // Perform op
        //      pFunction((int32_t*)pGroup, (int32_t*)pFirst, (int32_t*)pCount, (char*)pAccumBin, (char*)aInfo[i].pData,
        //      unique_rows, aInfo[i].ItemSize, funcParam); PyTuple_SET_ITEM(returnTuple, i,
