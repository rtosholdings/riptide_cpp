...
template <typename T> static T get_nth_element(T *first, T *last, size_t n) {
...
template <typename T> static size_t strip_nans(T *x, size_t n) {
...
// multi-threading.
#define ACCUM_INNER_LOOP(_index, _binLow, _binHigh)                            \
  if (_index >= _binLow && _index < _binHigh)
...
template <typename T, typename U, typename V> class GroupByBase {
public:
  GroupByBase(){};
  ~GroupByBase(){};
  ...
  static void AccumSum(void *pDataIn, void *pIndexT, int32_t *pCountOut,
                       void *pDataOut, int64_t len, int64_t binLow,
    ...
    for (int64_t i = 0; i < len; i++) {
      ...
      ACCUM_INNER_LOOP(index, binLow, binHigh) { pOut[index] += (U)pIn[i]; }
    }
  }

  // This routine is only for float32.  It will upcast to float64, add up all
  // the numbers, then convert back to float32
  static void AccumSumFloat(void *pDataIn, void *pIndexT, int32_t *pCountOut,
                            void *pDataOut, int64_t len, int64_t binLow,
                            int64_t binHigh, int64_t pass) {
  ...
  //-------------------------------------------------------------------------------
  static void AccumNanSum(void *pDataIn, void *pIndexT, int32_t *pCountOut,
                          void *pDataOut, int64_t len, int64_t binLow,
                          int64_t binHigh, int64_t pass) {
    T *pIn = (T *)pDataIn;
    U *pOut = (U *)pDataOut;
  ...
  static void AccumNanSumFloat(void *pDataIn, void *pIndexT, int32_t *pCountOut,
                               void *pDataOut, int64_t len, int64_t binLow,
                               int64_t binHigh, int64_t pass) {
    float *pIn = (float *)pDataIn;
    float *pOut = (float *)pDataOut;
  ...
  //-------------------------------------------------------------------------------
  static void AccumMin(void *pDataIn, void *pIndexT, int32_t *pCountOut,
                       void *pDataOut, int64_t len, int64_t binLow,
                       int64_t binHigh, int64_t pass) {
    T *pIn = (T *)pDataIn;
    U *pOut = (U *)pDataOut;
  ...
  //-------------------------------------------------------------------------------
  static void AccumNanMin(void *pDataIn, void *pIndexT, int32_t *pCountOut,
                          void *pDataOut, int64_t len, int64_t binLow,
                          int64_t binHigh, int64_t pass) {
    T *pIn = (T *)pDataIn;
    U *pOut = (U *)pDataOut;
  ...
  //-------------------------------------------------------------------------------
  static void AccumMax(void *pDataIn, void *pIndexT, int32_t *pCountOut,
                       void *pDataOut, int64_t len, int64_t binLow,
                       int64_t binHigh, int64_t pass) {
    T *pIn = (T *)pDataIn;
    U *pOut = (U *)pDataOut;
  ...
  //-------------------------------------------------------------------------------
  static void AccumNanMax(void *pDataIn, void *pIndexT, int32_t *pCountOut,
                          void *pDataOut, int64_t len, int64_t binLow,
                          int64_t binHigh, int64_t pass) {
    T *pIn = (T *)pDataIn;
    U *pOut = (U *)pDataOut;
  ...
  //-------------------------------------------------------------------------------
  static void AccumMean(void *pDataIn, void *pIndexT, int32_t *pCountOut,
                        void *pDataOut, int64_t len, int64_t binLow,
                        int64_t binHigh, int64_t pass) {
    T *pIn = (T *)pDataIn;
    U *pOut = (U *)pDataOut;
  ...
  //-------------------------------------------------------------------------------
  static void AccumMeanFloat(void *pDataIn, void *pIndexT, int32_t *pCountOut,
                             void *pDataOut, int64_t len, int64_t binLow,
                             int64_t binHigh, int64_t pass) {
    T *pIn = (T *)pDataIn;
    ...
    // Allocate pOut
    double *pOut =
        (double *)WORKSPACE_ALLOC(sizeof(double) * (binHigh - binLow));
    if (pOut) {
      if (pass <= 0) {
        // Clear out memory for our range
  ...
  //-------------------------------------------------------------------------------
  static void AccumNanMean(void *pDataIn, void *pIndexT, int32_t *pCountOut,
                           void *pDataOut, int64_t len, int64_t binLow,
                           int64_t binHigh, int64_t pass) {
    T *pIn = (T *)pDataIn;
    U *pOriginalOut = (U *)pDataOut;
  ...
  //-------------------------------------------------------------------------------
  static void AccumNanMeanFloat(void *pDataIn, void *pIndexT,
                                int32_t *pCountOut, void *pDataOut, int64_t len,
  ...
  //-------------------------------------------------------------------------------
  static void AccumVar(void *pDataIn, void *pIndexT, int32_t *pCountOut,
                       void *pDataOut, int64_t len, int64_t binLow,
                       int64_t binHigh, int64_t pass) {
    T *pIn = (T *)pDataIn;
    U *pOut = (U *)pDataOut;
  ...
  //-------------------------------------------------------------------------------
  static void AccumNanVar(void *pDataIn, void *pIndexT, int32_t *pCountOut,
                          void *pDataOut, int64_t len, int64_t binLow,
                          int64_t binHigh, int64_t pass) {
    T *pIn = (T *)pDataIn;
    U *pOut = (U *)pDataOut;
  ...
  //-------------------------------------------------------------------------------
  static void AccumStd(void *pDataIn, void *pIndexT, int32_t *pCountOut,
                       void *pDataOut, int64_t len, int64_t binLow,
                       int64_t binHigh, int64_t pass) {
  ...
  //-------------------------------------------------------------------------------
  static void AccumNanStd(void *pDataIn, void *pIndexT, int32_t *pCountOut,
                          void *pDataOut, int64_t len, int64_t binLow,
                          int64_t binHigh, int64_t pass) {
    U *pOut = (U *)pDataOut;

    AccumNanVar(pDataIn, pIndexT, pCountOut, pDataOut, len, binLow, binHigh,
                pass);
    for (int64_t i = binLow; i < binHigh; i++) {
      pOut[i] = sqrt(pOut[i]);
    }
  ...
  static void AccumNth(void *pColumn, void *pGroupT, int32_t *pFirst,
                       int32_t *pCount, void *pAccumBin, int64_t binLow,
                       int64_t binHigh, int64_t totalInputRows,
  ...
  //-------------------------------------------------------------------------------
  static void AccumNthString(void *pColumn, void *pGroupT, int32_t *pFirst,
                             int32_t *pCount, void *pAccumBin, int64_t binLow,
                             int64_t binHigh, int64_t totalInputRows,
                             int64_t itemSize, int64_t funcParam) {
    T *pSrc = (T *)pColumn;
  ...
  //-------------------------------------------------------------------------------
  // V is is the INDEX Type
  static void AccumFirst(void *pColumn, void *pGroupT, int32_t *pFirst,
                         int32_t *pCount, void *pAccumBin, int64_t binLow,
                         int64_t binHigh, int64_t totalInputRows,
                         int64_t itemSize, int64_t funcParam) {
    T *pSrc = (T *)pColumn;
    ...
    LOGGING(
        "in accum first low: %lld  high: %lld   group:%p  first:%p  count:%p\n",
  ...
  //-------------------------------------------------------------------------------
  static void AccumFirstString(void *pColumn, void *pGroupT, int32_t *pFirst,
                               int32_t *pCount, void *pAccumBin, int64_t binLow,
                               int64_t binHigh, int64_t totalInputRows,
                               int64_t itemSize, int64_t funcParam) {
    T *pSrc = (T *)pColumn;
  ...
  //-------------------------------------------------------------------------------
  static void AccumLastString(void *pColumn, void *pGroupT, int32_t *pFirst,
                              int32_t *pCount, void *pAccumBin, int64_t binLow,
                              int64_t binHigh, int64_t totalInputRows,
                              int64_t itemSize, int64_t funcParam) {
    T *pSrc = (T *)pColumn;
  ...
  static void AccumRollingSum(void *pColumn, void *pGroupT, int32_t *pFirst,
                              int32_t *pCount, void *pAccumBin, int64_t binLow,
                              int64_t binHigh, int64_t totalInputRows,
                              int64_t itemSize, int64_t funcParam) {
  ...
  // Rolling uses entire size: totalInputRows
  // TODO: Check if group is always int32_t
  static void AccumRollingNanSum(void *pColumn, void *pGroupT, int32_t *pFirst,
                                 int32_t *pCount, void *pAccumBin,
                                 int64_t binLow, int64_t binHigh,
                                 int64_t totalInputRows, int64_t itemSize,
                                 int64_t funcParam) {
  ...
  // Rolling uses entire size: totalInputRows
  // TODO: Check if group is always int32_t
  static void AccumRollingMean(void *pColumn, void *pGroupT, int32_t *pFirst,
                               int32_t *pCount, void *pAccumBin, int64_t binLow,
                               int64_t binHigh, int64_t totalInputRows,
                               int64_t itemSize, int64_t funcParam) {
  ...
  // Rolling uses entire size: totalInputRows
  // TODO: Check if group is always int32_t
  static void AccumRollingNanMean(void *pColumn, void *pGroupT, int32_t *pFirst,
                                  int32_t *pCount, void *pAccumBin,
                                  int64_t binLow, int64_t binHigh,
                                  int64_t totalInputRows, int64_t itemSize,
                                  int64_t funcParam) {
  ...
  // Rolling uses entire size: totalInputRows
  // TODO: Check if group is always int32_t
  static void AccumRollingCount(void *pColumn, void *pGroupT, int32_t *pFirst,
                                int32_t *pCount, void *pAccumBin,
                                int64_t binLow, int64_t binHigh,
                                int64_t totalInputRows, int64_t itemSize,
                                int64_t funcParam) {
  ...
  static void AccumRollingShift(void *pColumn, void *pGroupT, int32_t *pFirst,
                                int32_t *pCount, void *pAccumBin,
                                int64_t binLow, int64_t binHigh,
                                int64_t totalInputRows, int64_t itemSize,
                                int64_t funcParam) {
  ...
  // Rolling uses entire size: totalInputRows
  // TODO: Check if group is always int32_t
  static void AccumRollingDiff(void *pColumn, void *pGroupT, int32_t *pFirst,
                               int32_t *pCount, void *pAccumBin, int64_t binLow,
                               int64_t binHigh, int64_t totalInputRows,
                               int64_t itemSize, int64_t funcParam) {
  ...
  //
  static void AccumTrimMeanBR(void *pColumn, void *pGroupT, int32_t *pFirst,
                              int32_t *pCount, void *pAccumBin, int64_t binLow,
                              int64_t binHigh, int64_t totalInputRows,
                              int64_t itemSize, int64_t funcParam) {
    T *pSrc = (T *)pColumn;
  ...
  static void AccumMode(void *pColumn, void *pGroupT, int32_t *pFirst,
                        int32_t *pCount, void *pAccumBin, int64_t binLow,
                        int64_t binHigh, int64_t totalInputRows,
                        int64_t itemSize, int64_t funcParam) {
    T *pSrc = (T *)pColumn;
  ...
  // auto-nan
  // pGroup -> int8_t/16/32/64  (V typename)
  static void AccumMedian(void *pColumn, void *pGroupT, int32_t *pFirst,
                          int32_t *pCount, void *pAccumBin, int64_t binLow,
                          int64_t binHigh, int64_t totalInputRows,
                          int64_t itemSize, int64_t funcParam) {
    T *pSrc = (T *)pColumn;
    ...
    LOGGING("Median %llu  %lld  %lld  sizeof: %lld %lld %lld\n", totalInputRows,
            binLow, binHigh, sizeof(T), sizeof(U), sizeof(V));
  ...
  //-------------------------------------------------------------------------------
  static void AccumMedianString(void *pColumn, void *pGroupT, int32_t *pFirst,
                                int32_t *pCount, void *pAccumBin,
                                int64_t binLow, int64_t binHigh,
                                int64_t totalInputRows, int64_t itemSize,
                                int64_t funcParam) {
...
//-------------------------------------------------------------------
typedef void (*GROUPBY_GATHER_FUNC)(stGroupBy32 *pstGroupBy32, void *pDataIn,
                                    void *pDataOut, int32_t *pCountOut,
                                    int64_t numUnique, int64_t numCores,
                                    int64_t binLow, int64_t binHigh);

template <typename U>
static void GatherSum(stGroupBy32 *pstGroupBy32, void *pDataInT,
                      void *pDataOutT, int32_t *pCountOut, int64_t numUnique,
...
template <typename U>
static void GatherMean(stGroupBy32 *pstGroupBy32, void *pDataInT,
                       void *pDataOutT, int32_t *pCountOutBase,
                       int64_t numUnique, int64_t numCores, int64_t binLow,
                       int64_t binHigh) {
  U *pDataInBase = (U *)pDataInT;
  U *pDataOut = (U *)pDataOutT;
...
template <typename U>
static void GatherMinFloat(stGroupBy32 *pstGroupBy32, void *pDataInT,
                           void *pDataOutT, int32_t *pCountOutBase,
                           int64_t numUnique, int64_t numCores, int64_t binLow,
                           int64_t binHigh) {
  U *pDataInBase = (U *)pDataInT;
...
template <typename U>
static void GatherMin(stGroupBy32 *pstGroupBy32, void *pDataInT,
                      void *pDataOutT, int32_t *pCountOutBase,
                      int64_t numUnique, int64_t numCores, int64_t binLow,
                      int64_t binHigh) {
  U *pDataInBase = (U *)pDataInT;
...
template <typename U>
static void GatherMaxFloat(stGroupBy32 *pstGroupBy32, void *pDataInT,
                           void *pDataOutT, int32_t *pCountOutBase,
                           int64_t numUnique, int64_t numCores, int64_t binLow,
                           int64_t binHigh) {
  U *pDataInBase = (U *)pDataInT;
...
template <typename U>
static void GatherMax(stGroupBy32 *pstGroupBy32, void *pDataInT,
                      void *pDataOutT, int32_t *pCountOutBase,
                      int64_t numUnique, int64_t numCores, int64_t binLow,
                      int64_t binHigh) {
  U *pDataInBase = (U *)pDataInT;
...
static GROUPBY_GATHER_FUNC GetGroupByGatherFunction(int outputType,
                                                    GB_FUNCTIONS func) {
  switch (func) {
  case GB_SUM:
  case GB_NANSUM:
...
template <typename V>
static GROUPBY_TWO_FUNC GetGroupByFunction(bool *hasCounts,
                                           int32_t *wantedOutputType,
                                           int inputType, GB_FUNCTIONS func) {
...
template <typename V>
static GROUPBY_X_FUNC32 GetGroupByXFunction32(int inputType, int outputType,
                                              GB_FUNCTIONS func) {
...
static bool BandedGroupByCall(struct stMATH_WORKER_ITEM *pstWorkerItem,
  ...
  while ((index = pstWorkerItem->GetNextWorkIndex(&workBlock)) > 0) {
    ...
    LOGGING("|%d %d %lld %p %p %p", core, (int)workBlock, index, pDataIn,
            pCountOut, pDataOut);
    int64_t binLow = pGroupBy32->returnObjects[index].binLow;
    int64_t binHigh = pGroupBy32->returnObjects[index].binHigh;

    pFunctionX((void *)pDataIn, (void *)pGroupBy32->pGroup,
               (int32_t *)pGroupBy32->pFirst, (int32_t *)pGroupBy32->pCount,
               (char *)pDataOut, binLow, binHigh, pGroupBy32->totalInputRows,
               aInfo[0].ItemSize, pGroupBy32->funcParam);
...
//------------------------------------------------------------------------------
//  Concurrent callback from multiple threads
static bool ScatterGroupByCall(struct stMATH_WORKER_ITEM *pstWorkerItem,
                               int core, int64_t workIndex) {
  // -1 is the first core
  core = core + 1;
  ...
  while ((lenX = pstWorkerItem->GetNextWorkBlock(&workBlock)) > 0) {
    ...
    // shift pDataIn by T
    // shift pDataIn2 by U
    pFunction(pDataIn + inputAdj1, pDataIn2 + inputAdj2, pCountOut, pDataOut,
              lenX, binLow, binHigh, pass++);
...
void GroupByCall(void *pGroupBy, int64_t i) {
  ...
  if (outArray && pFunction) {
    LOGGING("col %llu  ==> outsize %llu   len: %llu   numpy types %d --> %d   "
            "%d %d\n",
            i, uniqueRows, len, aInfo[i].NumpyDType, numpyOutType,
            gNumpyTypeToSize[aInfo[i].NumpyDType],
    ...
    if (typeCall == ANY_GROUPBY_FUNC) {
      ...
      pFunction(pDataIn, pDataIn2 /* USE IKEY which can be int8/16/32/64*/,
                pCountOut, pDataOut, len, binLow, binHigh, -1);
      ...
      if (pFunctionX) {
        pFunctionX(
            ...
            (int32_t *)pGroupBy32->pFirst, (int32_t *)pGroupBy32->pCount,
            (char *)pDataOut, binLow, binHigh, pGroupBy32->totalInputRows,
            aInfo[i].ItemSize, pGroupBy32->funcParam);
      } else {
    ...
    LOGGING("**skipping col %llu  ==> outsize %llu   len: %llu   numpy types "
            "%d --> %d   %d %d\n",
            i, uniqueRows, len, aInfo[i].NumpyDType, numpyOutType,
            gNumpyTypeToSize[aInfo[i].NumpyDType],
            gNumpyTypeToSize[numpyOutType]);
...
PyObject *GroupByAll64(PyObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "OO!LL", &inList1, &PyArray_Type, &inArr2,
                        &unique_rows, &funcNum)) {
...
//---------------------------------------------------------------
GROUPBY_TWO_FUNC GetGroupByFunctionStep1(int32_t iKeyType, bool *hasCounts,
  ...
  switch (iKeyType) {
  case NPY_INT8:
    pFunction = GetGroupByFunction<int8_t>(hasCounts, numpyOutType, numpyInType,
                                           funcNum);
    break;
  case NPY_INT16:
    pFunction = GetGroupByFunction<int16_t>(hasCounts, numpyOutType,
                                            numpyInType, funcNum);
    break;
  CASE_NPY_INT32:
    pFunction = GetGroupByFunction<int32_t>(hasCounts, numpyOutType,
                                            numpyInType, funcNum);
    break;
  CASE_NPY_INT64:

    pFunction = GetGroupByFunction<int64_t>(hasCounts, numpyOutType,
                                            numpyInType, funcNum);
    break;
  }
...
PyObject *GroupBySingleOpMultiBands(
    ArrayInfo *aInfo, PyArrayObject *iKey, PyArrayObject *iFirst,
    PyArrayObject *iGroup, PyArrayObject *nCount, GB_FUNCTIONS firstFuncNum,
    int64_t unique_rows, int64_t tupleSize, int64_t binLow, int64_t binHigh) {
  ...
  switch (iKeyType) {
  case NPY_INT8:
    pFunction = GetGroupByXFunction32<int8_t>(numpyOutType, numpyOutType,
                                              (GB_FUNCTIONS)firstFuncNum);
    break;
  case NPY_INT16:
    pFunction = GetGroupByXFunction32<int16_t>(numpyOutType, numpyOutType,
                                               (GB_FUNCTIONS)firstFuncNum);
    break;
  CASE_NPY_INT32:
    pFunction = GetGroupByXFunction32<int32_t>(numpyOutType, numpyOutType,
                                               (GB_FUNCTIONS)firstFuncNum);
    break;
  CASE_NPY_INT64:

    pFunction = GetGroupByXFunction32<int64_t>(numpyOutType, numpyOutType,
                                               (GB_FUNCTIONS)firstFuncNum);
    break;
  }
  ...
  if (pFunction) {
    ...
    if (pWorkItem && cores > 0) {
      ...
      stGroupBy32 *pstGroupBy32 = (stGroupBy32 *)WORKSPACE_ALLOC(
          sizeof(stGroupBy32) + (cores * sizeof(stGroupByReturn)));
      ...
      pstGroupBy32->typeOfFunctionCall =
          TYPE_OF_FUNCTION_CALL::ANY_GROUPBY_XFUNC32;

      pstGroupBy32->totalInputRows = arraySizeKey;

      LOGGING("groupby dtypes:  key:%d  ifirst:%d  igroup:%d  count:%d\n",
              PyArray_TYPE(iKey), PyArray_TYPE(iFirst), PyArray_TYPE(iGroup),
              PyArray_TYPE(nCount));
...
// For some operations we can multithread by scattering the work
// and then gathering the work from threads.
PyObject *GroupBySingleOpMultithreaded(ArrayInfo *aInfo, PyArrayObject *iKey,
                                       GB_FUNCTIONS firstFuncNum,
                                       int64_t unique_rows, int64_t tupleSize,
                                       int64_t binLow, int64_t binHigh) {
  // Parallel one way
  // Divide up by memory
  PyObject *returnTuple = NULL;
  ...
  GROUPBY_TWO_FUNC pFunction =
      GetGroupByFunctionStep1(iKeyType, &hasCounts, &numpyOutType,
                              aInfo[0].NumpyDType, (GB_FUNCTIONS)firstFuncNum);
  ...
  if (pFunction && numpyOutType != -1) {
    ...
    if (pWorkItem != NULL) {
      ...
      // later
      char *pWorkspace =
          (char *)WORKSPACE_ALLOC(unique_rows * itemSize * numCores);
      ...
      // objects being produced
      stGroupBy32 *pstGroupBy32 = (stGroupBy32 *)WORKSPACE_ALLOC(
          sizeof(stGroupBy32) + (numCores * sizeof(stGroupByReturn)));
      ...
      pstGroupBy32->totalInputRows = arraySizeKey;
      pstGroupBy32->typeOfFunctionCall =
          TYPE_OF_FUNCTION_CALL::ANY_GROUPBY_FUNC;
      ...
      for (int i = 0; i < numCores; i++) {
        ...
        // Assign working memory per call
        pstGroupBy32->returnObjects[i].pOutArray =
            &pWorkspace[unique_rows * i * itemSize];
      ...
      GROUPBY_GATHER_FUNC pGather =
          GetGroupByGatherFunction(numpyOutType, (GB_FUNCTIONS)firstFuncNum);
      if (pGather) {
        void *pDataOut = PyArray_BYTES(outArray);
        pGather(pstGroupBy32, pWorkspace, pDataOut, pCountOut, unique_rows,
                numCores, binLow, binHigh);
      } else {
...
PyObject *GroupByAll32(PyObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "OO!LO!O!O!O", &inList1, &PyArray_Type, &iKey,
                        &unique_rows, &PyList_Type, &listFuncNum, &PyList_Type,
                        &listBinLow, &PyList_Type, &listBinHigh, &param)) {
  ...
  default:
    PyErr_Format(
        PyExc_ValueError,
        "GroupByAll32 key param must be int8, int16, int32, int64 not type %d",
        iKeyType);
    return NULL;
  }
  ...
  if (tupleSize != funcTupleSize) {
    PyErr_Format(
        PyExc_ValueError,
        "GroupByAll32 func numbers do not match array columns %lld %lld",
        tupleSize, funcTupleSize);
    return NULL;
  }
  ...
  if (tupleSize != binTupleSize) {
    PyErr_Format(
        PyExc_ValueError,
        "GroupByAll32 bin numbers do not match array columns %lld %lld",
        tupleSize, binTupleSize);
    return NULL;
  }
  ...
  if (aInfo->ArrayLength != arraySizeKey) {
    PyErr_Format(
        PyExc_ValueError,
        "GroupByAll32 iKey length does not match value length %lld %lld",
        aInfo->ArrayLength, arraySizeKey);
    return NULL;
  }

  int overflow = 0;
  int64_t firstFuncNum =
  ...
  if (true && ((unique_rows * 10) < arraySizeKey) && tupleSize == 1) {
    ...
    int64_t binLow =
        PyLong_AsLongLongAndOverflow(PyList_GET_ITEM(listBinLow, 0), &overflow);
    int64_t binHigh = PyLong_AsLongLongAndOverflow(
        PyList_GET_ITEM(listBinHigh, 0), &overflow);
...

    {
      ...
      returnTuple =
          GroupBySingleOpMultithreaded(aInfo, iKey, (GB_FUNCTIONS)firstFuncNum,
                                       unique_rows, tupleSize, binLow, binHigh);
    }
  }
  ...
  if (returnTuple == NULL) {
    ...
    // being produced
    stGroupBy32 *pstGroupBy32 = (stGroupBy32 *)WORKSPACE_ALLOC(
        sizeof(stGroupBy32) + (tupleSize * sizeof(stGroupByReturn)));
    ...
    for (int i = 0; i < tupleSize; i++) {
      ...
      int overflow = 0;
      int64_t funcNum = PyLong_AsLongLongAndOverflow(
          PyList_GET_ITEM(listFuncNum, i), &overflow);
      pstGroupBy32->returnObjects[i].funcNum = (int32_t)funcNum;

      int64_t binLow = PyLong_AsLongLongAndOverflow(
          PyList_GET_ITEM(listBinLow, i), &overflow);
      pstGroupBy32->returnObjects[i].binLow = binLow;

      int64_t binHigh = PyLong_AsLongLongAndOverflow(
          PyList_GET_ITEM(listBinHigh, i), &overflow);
      pstGroupBy32->returnObjects[i].binHigh = binHigh;
      ...
      if (pFunction && numpyOutType != -1) {
        // Dont bother allocating if we cannot call the function
        outArray =
            AllocateNumpyArray(1, (npy_intp *)&unique_rows, numpyOutType);
        CHECK_MEMORY_ERROR(outArray);
...
PyObject *GroupByAllPack32(PyObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "OO!O!O!O!LO!O!O!L", &inList1, &PyArray_Type,
                        &iKey, &PyArray_Type, &iGroup, &PyArray_Type, &iFirst,
                        &PyArray_Type, &nCount,

                        &unique_rows, &PyList_Type, &listFuncNum, &PyList_Type,
                        &listBinLow, &PyList_Type, &listBinHigh, &funcParam)) {

    return NULL;
  }

  LOGGING("GroupByAllPack32 types: key:%d  group:%d  first:%d  count:%d\n",
          PyArray_TYPE(iKey), PyArray_TYPE(iGroup), PyArray_TYPE(iFirst),
          PyArray_TYPE(nCount));
  ...
  default:
    PyErr_Format(PyExc_ValueError,
                 "GroupByAllPack32 key param must int8, int16, int32, int64");
    return NULL;
  }
  ...
  if (tupleSize == 1 && arraySizeKey > 65536) {
    ...
    int64_t firstFuncNum = PyLong_AsLongLongAndOverflow(
        PyList_GET_ITEM(listFuncNum, 0), &overflow);
...

    {
      returnTuple = GroupBySingleOpMultiBands(
          aInfo, iKey, iFirst, iGroup, nCount, (GB_FUNCTIONS)firstFuncNum,
          unique_rows, tupleSize, binLow, binHigh);
    }
  }
  ...
  if (returnTuple == NULL) {
    ...
    // being produced
    int64_t allocSize =
        (sizeof(stGroupBy32) + 8 + sizeof(stGroupByReturn)) * tupleSize;
      ...
      if (pFunction) {
        ...
        if (funcNum == GB_TRIMBR) {
          ...
          if (funcNum >= GB_ROLLING_SUM) {
            ...
            if (funcNum == GB_ROLLING_SUM || funcNum == GB_ROLLING_NANSUM ||
                funcNum == GB_ROLLING_COUNT) {
            ...
            } else if (funcNum == GB_ROLLING_MEAN ||
                       funcNum == GB_ROLLING_NANMEAN) {
              numpyOutType = NPY_FLOAT64;
            }
