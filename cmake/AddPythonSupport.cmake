...
if(DEFINED RIPTIDE_PYTHON_VER)
  set(_PYTHON_VERSION "${RIPTIDE_PYTHON_VER}")
endif()
unset(_FIND_EXACT)
...
find_package(Python3 ${_PYTHON_VERSION} ${_FIND_EXACT} COMPONENTS Interpreter Development REQUIRED)
...
find_package(Python3 ${_PYTHON_VERSION} ${_FIND_EXACT} COMPONENTS Interpreter Development NumPy)
